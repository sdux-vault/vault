...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Defines configuration options for lookup behavior execution.<br/><br/>
...
result into the pipeline.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            Function invoked to retrieve an entity when it is not present in cache.<br/><br/>
The returned value is submitted directly into the pipeline for resolution
according to the configured resolve type.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
...
entities during lookup operations.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
