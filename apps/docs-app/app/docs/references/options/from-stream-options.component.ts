 ...
 * Symbol: <a href="/docs/references/options/from-stream-options">FromStreamOptions</a>
 */

import { Component, ViewEncapsulation } from '@angular/core';

@Component({
  selector: 'sdux-from-stream-options',
  standalone: true,
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Configuration options for stream-based state observation.<br/><br/></div>
        ...
        <div class="section-body">
          <table aria-label="Properties">
            ...
            <tbody>
              <tr>
          <td class="column-300">
            <strong>autoResetError?</strong>
            
            <p class="type">type: boolean</p>
            
          </td>
          <td class="column-auto">
            When true (default), any successful next clears the error state.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
...
export class FromStreamOptionsComponent {}
