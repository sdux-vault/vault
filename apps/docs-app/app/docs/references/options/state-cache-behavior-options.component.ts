...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Defines configuration options that control state cache behavior.<br/><br/>
These options specify cache lifetime, entity identification, and
how cache misses are resolved through the state pipeline.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            Function invoked to resolve an entity when a cache miss occurs.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
          ...
          <td class="column-auto">
            Resolution strategy used to execute cache miss fetch operations.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>idKey</strong>
          ...
          <td class="column-auto">
            Property name used to extract a unique identifier from entities.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>ttl</strong>
            
            <p class="type">type: <a href="/docs/references/types/cache-ttl-type">CacheTTLType</a></p>
            
          </td>
          <td class="column-auto">
            Time-to-live value that determines how long cached entries remain valid.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
