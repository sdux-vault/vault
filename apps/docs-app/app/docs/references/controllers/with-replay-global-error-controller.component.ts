...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Controller that conditionally blocks pipeline attempts when a global error is active.<br/><br/>
This controller observes incoming controller messages and votes to deny execution
when a global error is present, otherwise abstaining from intervention.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            Handles incoming controller messages and produces a vote based on global error state.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-300">
            ...
            <p class="default">default: <a href="/docs/pipeline/controllers/with-replay-global-error-controller">withReplayGlobalErrorController</a>.type</p>
          </td>
          <td class="column-auto">
