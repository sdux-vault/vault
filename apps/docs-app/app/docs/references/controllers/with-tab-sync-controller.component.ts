...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Controller that coordinates initial cross-tab state negotiation for Tab Sync.<br/><br/>
...
the controller abstains and commands the behavior to proceed normally.<br/><br/>
After the first conduct, the controller abstains on all subsequent attempts
and responds to snapshot requests from newly opened tabs.<br/><br/></div>
...
<section class="section">
        ...
        <li>key: string</li><li>controllerCtx: <a href="/docs/references/contexts/controller-class-context">ControllerClassContext</a></li>
                ...
                <td>
                  Creates a new tab sync controller instance.<br/><br/>
                </td>
              </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            Handles a snapshot request from a new tab by commanding the behavior to send its current snapshot.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Handles incoming BroadcastChannel messages from other tabs&#39; controllers.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Opens the BroadcastChannel for cross-tab controller negotiation.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Returns all non-stale peer entries from the registry, excluding this tab.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Updates this tab&#39;s timestamp in the registry to the current time.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Writes this tab&#39;s entry into the localStorage tab registry and registers a beforeunload listener.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Removes this tab&#39;s entry from the localStorage tab registry and unregisters the beforeunload listener.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Sends a snapshot request on the BroadcastChannel to all peer tabs.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>snapshot: <a href="/docs/references/shapes/state-snapshot-shape">StateSnapshotShape</a></li>
          </ul>
            <p>returns: void</p>
          </td>
          <td>
            Sends a snapshot response on the BroadcastChannel to peer tabs.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Starts a periodic timer that refreshes this tab&#39;s timestamp in the registry.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Stops the heartbeat timer.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Subscribes to behavior notifications on the bus to receive peer snapshot signals.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Subscribes to SnapshotReady notifications and forwards the snapshot to peer tabs.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Cleans up controller resources, removes the tab from the registry, and closes the channel.<br/><br/>
          </td>
        </tr><tr>
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>message: <a href="/docs/references/types/controller-message-shape">ControllerMessageShape</a></li>
          </ul>
            <p>returns: Observable&lt;<a href="/docs/references/types/controller-vote">ControllerVote</a>&gt;</p>
          </td>
          <td>
            Handles controller admission messages and performs cross-tab negotiation on the first attempt.<br/><br/>
          </td>
        </tr><tr>
          <td>
            <strong>reset</strong>
          ...
          <td>
            Resets controller negotiation state.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            Shared bus service used for controller-to-behavior communication.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
          ...
          <td class="column-auto">
            Subscription to snapshot-ready notifications from the local behavior.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
          ...
          <td class="column-auto">
            Indicates that this controller is non-critical in the pipeline.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>critical</strong>
            <p class="modifiers">readonly</p>
            <p class="type">type: unknown</p>
            <p class="default">default: <a href="/docs/pipeline/controllers/with-tab-sync-controller">withTabSyncController</a>.critical</p>
          </td>
          <td class="column-auto">
            Indicates whether this controller is critical for pipeline execution.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>key</strong>
          ...
          <td class="column-300">
            ...
            <p class="modifiers">readonly</p>
            <p class="type">type: unknown</p>
            <p class="default">default: <a href="/docs/pipeline/controllers/with-tab-sync-controller">withTabSyncController</a>.type</p>
          </td>
          <td class="column-auto">
