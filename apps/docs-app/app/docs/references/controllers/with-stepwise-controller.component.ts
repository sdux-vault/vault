...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Controller that coordinates stepwise policy decisions by serializing requests
and mediating responses between behaviors and external decision producers.<br/><br/>
...
them when a corresponding response is received.<br/><br/></div>
...
<section class="section">
        ...
        <li>key: string</li><li>controllerCtx: <a href="/docs/references/contexts/controller-class-context">ControllerClassContext</a></li>
                ...
                <td>
                  Creates a new stepwise controller instance and wires bus subscriptions.<br/><br/>
                </td>
              </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            Processes an external response and resolves the active request.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Advances the request queue and emits the next request when idle.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Cleans up controller resources and unsubscribes from bus streams.<br/><br/>
          </td>
        </tr><tr>
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>_: <a href="/docs/references/types/controller-message-shape">ControllerMessageShape</a></li>
          </ul>
            <p>returns: Observable&lt;<a href="/docs/references/types/controller-vote">ControllerVote</a>&gt;</p>
          </td>
          <td>
            Handles controller admission messages by abstaining from all votes.<br/><br/>
          </td>
        </tr><tr>
          <td>
            <strong>reset</strong>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            Shared stepwise bus used for request, response, and answer signaling.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
          ...
          <td class="column-300">
            ...
            <p class="modifiers">readonly</p>
            <p class="type">type: unknown</p>
            <p class="default">default: <a href="/docs/pipeline/controllers/with-stepwise-controller">withStepwiseController</a>.critical</p>
          </td>
          <td class="column-auto">
          ...
          <td class="column-300">
            ...
            <p class="modifiers">readonly</p>
            <p class="type">type: unknown</p>
            <p class="default">default: <a href="/docs/pipeline/controllers/with-stepwise-controller">withStepwiseController</a>.type</p>
          </td>
          <td class="column-auto">
