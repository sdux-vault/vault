...
@Component({
  ...
  template: `<div class="docs-container">
      <div class="header">
        <h3>withMaxFailuresController</h3>
      </div>
      <header class="docs-header">
        <div class="lead">Error controller that tracks per-trace failure counts and aborts pipeline
attempts once the configured maximum number of failures is exceeded.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            Evaluates an incoming controller message against the failure threshold.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Installs the fluent withMaxFailures configuration method on the <a href="/docs/references/functions/feature-cell">FeatureCell</a>.<br/><br/>
          </td>
        </tr><tr>
          <td>
            <strong>reset</strong>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            Configuration key used to locate max-failure options in the config registry.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
          ...
          <td class="column-300">
            ...
            <p class="default">default: <a href="/docs/pipeline/controllers/with-max-failures-controller">withMaxFailuresController</a>.critical</p>
          </td>
          <td class="column-auto">
          ...
          <td class="column-300">
            ...
            <p class="modifiers">readonly</p>
            <p class="type">type: unknown</p>
            <p class="default">default: <a href="/docs/pipeline/controllers/with-max-failures-controller">withMaxFailuresController</a>.type</p>
          </td>
          <td class="column-auto">
