...
@Component({
  ...
  template: `<div class="docs-container">
      <div class="header">
        <h3>withDelayController</h3>
      </div>
      <header class="docs-header">
        <div class="lead">Policy controller that delays pipeline execution by a configured interval.<br/><br/>
...
to allow the trace to proceed through the pipeline.<br/><br/></div>
...
<section class="section">
        ...
        <ul>
          <li><a href="/docs/references/contracts/controller-contract">ControllerContract</a></li>
                ...
                <td>
                  Creates a withDelay controller instance.<br/><br/>
                </td>
              </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            Clears the active revote timer.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Destroys the controller by clearing all queued traces and timers.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Handles a controller message by queuing or releasing traces based on delay.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Installs the withDelay fluent API on a <a href="/docs/references/functions/feature-cell">FeatureCell</a> builder.<br/><br/>
          </td>
        </tr><tr>
          <td>
            <strong>reset</strong>
          ...
          <td>
            Resets the controller by clearing all queued traces and timers.<br/><br/>
          </td>
        </tr><tr>
          <td>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-300">
            ...
            <p class="default">default: <a href="/docs/pipeline/controllers/with-delay-controller">withDelayController</a>.critical</p>
          </td>
          <td class="column-auto">
          ...
          <td class="column-auto">
            Fluent API installation function for <a href="/docs/references/functions/feature-cell">FeatureCell</a> builders.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>key</strong>
          ...
          <td class="column-300">
            ...
            <p class="modifiers">readonly</p>
            <p class="type">type: unknown</p>
            <p class="default">default: <a href="/docs/pipeline/controllers/with-delay-controller">withDelayController</a>.type</p>
          </td>
          <td class="column-auto">
