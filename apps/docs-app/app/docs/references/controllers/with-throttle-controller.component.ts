  ...
  template: `<div class="docs-container">
    ...
    <header class="docs-header">
      <div class="lead">
        ...
        attempts, aborting any attempt that occurs within the cooldown
        period.<br /><br />
      </div>
    </header>
        ...
        <table aria-label="Constructor">
          ...
          <tbody>
            <tr>
              ...
              <td>Creates a new throttle controller instance.<br /><br /></td>
            </tr>
          </tbody>
        </table>
      </div>
        ...
        <table aria-label="Methods">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                Evaluates an incoming controller message against the throttle
                window.<br /><br />
              </td>
            </tr>
            <tr>
              ...
              <td>
                Installs the fluent withThrottle configuration method on the
            ...
            <tr>
              ...
              <td>
                Resets the throttle window to allow the next attempt
                immediately.<br /><br />
              </td>
            </tr>
          </tbody>
          ...
          <tbody>
            <tr>
              ...
              <td class="column-auto">
                Configuration key used to locate throttle options in the config
                registry.<br /><br />
              </td>
            </tr>
            <tr>
