...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Array merge behavior for Vault.<br/><br/>
...
are returned directly without transformation.<br/><br/>
This behavior is marked as critical, ensuring it participates in every
merge pipeline unless explicitly replaced by a custom merge behavior.<br/><br/></div>
...
<section class="section">
        ...
        <ul>
          <li><a href="/docs/references/contracts/merge-behavior-contract">MergeBehaviorContract</a></li>
                ...
                <td>
                  Creates a new array merge behavior instance.<br/><br/>
                </td>
              </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>currentValue: <a href="/docs/references/types/pipeline-upstream-value">PipelineUpstreamValue</a> | undefined</li><li>nextValue: <a href="/docs/references/types/pipeline-upstream-value">PipelineUpstreamValue</a> | undefined</li><li>options?: <a href="/docs/references/config/merge-config">MergeConfig</a></li>
          </ul>
            <p>returns: <a href="/docs/references/types/pipeline-upstream-value">PipelineUpstreamValue</a>&lt;T&gt;</p>
          </td>
          <td>
            Computes the merged state value using array-replacement semantics.<br/><br/>
...
- All other values pass through as-is.<br/><br/>
          </td>
        </tr><tr>
          <td>
...
This merge behavior maintains no resources and requires no cleanup.<br/><br/>
          </td>
        </tr><tr>
          <td>
            <strong>reset</strong>
...
diagnostic event for DevTools and monitoring.<br/><br/>
After reset, this behavior continues to operate identically to before.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-300">
            ...
            <p class="type">type: unknown</p>
            <p class="default">default: <a href="/docs/pipeline/behaviors/merge/with-array-merge-behavior">withArrayMergeBehavior</a>.critical</p>
          </td>
          <td class="column-auto">
          ...
          <td class="column-300">
            ...
            <p class="modifiers">readonly</p>
            <p class="type">type: unknown</p>
            <p class="default">default: <a href="/docs/pipeline/behaviors/merge/with-array-merge-behavior">withArrayMergeBehavior</a>.type</p>
          </td>
          <td class="column-auto">
