...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">AES-256-GCM encryption behavior that encrypts and decrypts persisted state values.
This behavior derives a symmetric encryption key from consumer-supplied configuration and applies encryption during persistence and decryption during restoration.<br/><br/></div>
...
<section class="section">
        ...
        <li>key: string</li><li>behaviorCtx: <a href="/docs/references/contexts/behavior-class-context">BehaviorClassContext</a></li>
                  ...
                  <p>implements:</p>
        <ul>
          <li><a href="/docs/references/contracts/encrypt-behavior-contract">EncryptBehaviorContract</a></li>
        </ul>
                </td>
                <td>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            Derives and imports an AES-256-GCM CryptoKey from the configured secret.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>_ctx: <a href="/docs/references/contexts/behavior-context">BehaviorContext</a></li><li>encrypted: T</li>
          </ul>
          ...
          <td>
            Releases cached cryptographic material held by this behavior instance.<br/><br/>
          </td>
        </tr><tr>
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>_ctx: <a href="/docs/references/contexts/behavior-context">BehaviorContext</a></li><li>current: <a href="/docs/references/types/pipeline-persist-value">PipelinePersistValue</a></li>
          </ul>
            <p>returns: Promise&lt;<a href="/docs/references/types/pipeline-persist-value">PipelinePersistValue</a>&lt;T&gt;&gt;</p>
          </td>
          <td>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-300">
            ...
            <p class="type">type: <a href="/docs/references/options/aes256behavior-options">AES256BehaviorOptions</a></p>
          ...
          <td class="column-300">
            ...
            <p class="default">default: <a href="/docs/pipeline/addons/encrypt/with-aes256encrypt-behavior">withAes256EncryptBehavior</a>.critical</p>
          </td>
          <td class="column-auto">
          ...
          <td class="column-300">
            ...
            <p class="modifiers">readonly</p>
            <p class="type">type: unknown</p>
            <p class="default">default: <a href="/docs/pipeline/addons/encrypt/with-aes256encrypt-behavior">withAes256EncryptBehavior</a>.type</p>
          </td>
          <td class="column-auto">
