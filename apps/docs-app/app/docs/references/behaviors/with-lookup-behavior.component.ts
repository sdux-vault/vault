  ...
  template: `<div class="docs-container">
    ...
    <header class="docs-header">
      <div class="lead">
        ...
        extension behavior that provides entity lookup capabilities.<br /><br />
        This behavior enables cached and on-demand lookup of entities by
        identifier, coordinating cache state, pending requests, and pipeline
        fetch resolution based on configured lookup options.<br /><br />
      </div>
    </header>
        ...
        <table aria-label="Constructor">
          ...
          <tbody>
            <tr>
              ...
              <td>Creates a new lookup behavior instance.<br /><br /></td>
            </tr>
          </tbody>
        </table>
      </div>
        ...
        <table aria-label="Methods">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                Removes a cached entity and resolves any pending lookups for the
                identifier.<br /><br />
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>Records an entity in the lookup cache.<br /><br /></td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              <td>
                ...
                <p>
                  returns: &#123; lookup: (id: string) =&gt;
                  Promise&lt;TEntity&gt;; lookup$(id: string):
                  Observable&lt;TEntity&gt;; &#125;
                </p>
              </td>
              <td>
                ...
                <a href="/docs/references/functions/feature-cell"
                  >FeatureCell</a
                >
                API with lookup functions.<br /><br />
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                Installs the fluent lookup configuration API onto the
                <a href="/docs/references/functions/feature-cell">FeatureCell</a
                >.<br /><br />
              </td>
            </tr>
          ...
          <tbody>
            ...
            <tr>
              <td class="column-300">
                ...
                <p class="type">
                  type:
                  <a href="/docs/references/options/lookup-behavior-options"
                    >LookupBehaviorOptions</a
                  >
                </p>
              </td>
              <td class="column-auto">
            ...
            <tr>
              ...
              <td class="column-auto">
                Internal key used to associate lookup options with state
                emissions.<br /><br />
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="column-auto">
                Static extension function used to augment the
                <a href="/docs/references/functions/feature-cell"
                  >FeatureCell</a
                >
                API.<br /><br />
