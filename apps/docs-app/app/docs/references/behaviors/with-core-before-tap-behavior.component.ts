...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Core tap behavior executed before reducer evaluation.<br/><br/>
...
abstraction and does not modify pipeline state or control flow.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>current: <a href="/docs/references/types/pipeline-upstream-value">PipelineUpstreamValue</a></li><li>tap: <a href="/docs/references/types/tap-callback">TapCallback</a></li>
          </ul>
            <p>returns: void</p>
          </td>
          <td>
...
does not influence reducer logic or state resolution.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-300">
            ...
            <p class="default">default: <a href="/docs/references/const/behavior-types">BehaviorTypes</a>.CoreBeforeTap</p>
          </td>
          <td class="column-auto">
            Pipeline behavior type indicating execution occurs prior to reducers.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
