...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Core behavior responsible for invoking emitState callbacks.<br/><br/>
...
state emission events without mutating pipeline state.<br/><br/>
It is critical to pipeline execution and always runs during emitState
processing when a callback is provided.<br/><br/></div>
...
<section class="section">
        ...
        <li>key: string</li><li>behaviorCtx: <a href="/docs/references/contexts/behavior-class-context">BehaviorClassContext</a></li>
                  ...
                  <p>implements:</p>
        <ul>
          <li><a href="/docs/references/contracts/core-emit-state-behavior-contract">CoreEmitStateBehaviorContract</a></li>
        </ul>
                </td>
                <td>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>snapshot: <a href="/docs/references/shapes/state-snapshot-shape">StateSnapshotShape</a></li><li>callback: <a href="/docs/references/types/core-emit-state-callback">CoreEmitStateCallback</a></li>
          </ul>
            <p>returns: <a href="/docs/references/types/core-emit-state-result">CoreEmitStateResult</a></p>
          </td>
          <td>
            Executes a provided emitState callback with the current state snapshot.<br/><br/>
If the callback is not a function or throws during execution, the behavior
logs the failure and returns <a href="/docs/references/const/vault_noop">VAULT_NOOP</a> without interrupting pipeline flow.<br/><br/>
          </td>
        </tr><tr>
          <td>
            <strong>reset</strong>
...
no reset logic beyond lifecycle participation.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            Indicates that emitState behavior is required in the pipeline.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>critical</strong>
          ...
          <td class="column-auto">
            Indicates that this behavior must always run during emitState execution.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>key</strong>
          ...
          <td class="column-300">
            ...
            <p class="modifiers">readonly</p>
            <p class="type">type: unknown</p>
            <p class="default">default: <a href="/docs/references/const/behavior-types">BehaviorTypes</a>.CoreEmitState</p>
          </td>
          <td class="column-auto">
