...
@Component({
  ...
  template: `<div class="docs-container">
    <div class="header">
      <h2>
        <a href="/docs/pipeline/addons/merge/with-array-append-merge-behavior"
    ...
    <header class="docs-header">
      <div class="lead">
        ...
        When both the current and incoming values are arrays, it returns a new
        array containing the concatenation of both values ([...curr,
        ...next]).<br /><br />
        If either value is not an array, the incoming value is returned
        as-is.<br /><br />
        Merge behavior is pure, meaning it never mutates the input arrays. It
        also supports a clearUndefined option, which converts an explicit
        undefined incoming value into a
          ...
          <tbody>
            <tr>
              ...
              <td>
                ...
                - If both values are arrays → returns a new array containing
                both. - If the incoming value is undefined and clearUndefined is
                enabled, the behavior returns
                <a href="/docs/references/const/vault_noop">VAULT_NOOP</a> to
                signal an intentional clear. - If only one value is an array →
                returns the incoming value as-is.<br /><br />
                This method is executed during the merge stage of the pipeline
                and must remain pure and side-effect free.<br /><br />
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                ...
                This behavior maintains no internal resources and requires no
                cleanup.<br /><br />
              </td>
            </tr>
            <tr>
              ...
              <td>
                ...
                Array append merge is a stateless, pure behavior and does not
                maintain any internal data, timers, or cached values. Resetting
                this behavior simply records the reset event for diagnostics and
                DevTools inspection.<br /><br />
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table aria-label="Properties">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="column-auto">
                Indicates that this instance of the merge behavior is
                critical.<br /><br />
              </td>
            </tr>
            <tr>
              ...
              <td class="column-auto">The static key<br /><br /></td>
            </tr>
            <tr>
              <td class="column-300">
                <strong>key</strong>
