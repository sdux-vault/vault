...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Core filter behavior for Vault.<br/><br/>
...
- undefined to indicate that the state update should be aborted<br/><br/>
...
detected, a controlled Vault error is thrown.<br/><br/>
Filters MUST be pure and must not mutate the incoming value.<br/><br/></div>
...
<section class="section">
        ...
        <li>key: string</li><li>behaviorCtx: <a href="/docs/references/contexts/behavior-class-context">BehaviorClassContext</a></li>
                  ...
                  <p>implements:</p>
        <ul>
          <li><a href="/docs/references/contracts/filter-behavior-contract">FilterBehaviorContract</a></li>
        </ul>
                </td>
                <td>
                  Creates a new filter behavior instance.<br/><br/>
                </td>
              </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>current: T</li><li>next: T</li>
          </ul>
            <p>returns: boolean</p>
          </td>
          <td>
            Performs type validation when filtering array state values.<br/><br/>
Ensures the filtered output remains an array when the input was an array.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Performs type validation when filtering object-based state values.<br/><br/>
Ensures the filter returns a valid non-null object of compatible structure.<br/><br/>
          </td>
        </tr><tr>
          <td>
...
Ensures the filter output matches the primitive type of the input.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Emits detailed debug output when filter output does not align with the input type.<br/><br/>
          </td>
        </tr><tr>
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>current: T</li><li>filter: <a href="/docs/references/types/filter-function">FilterFunction</a></li>
          </ul>
...
Filters must not mutate the incoming value and should remain pure.<br/><br/>
          </td>
        </tr><tr>
          <td>
...
performs no functional work. It exists to support the <a href="/docs/references/functions/feature-cell">FeatureCell</a> reset
lifecycle and provides a diagnostic hook for DevTools and monitoring.<br/><br/>
After reset, the behavior continues operating identically to before.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            Indicates that this behavior must always run as part of filtering.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>key</strong>
          ...
          <td class="column-300">
            ...
            <p class="modifiers">readonly</p>
            <p class="type">type: unknown</p>
            <p class="default">default: <a href="/docs/references/const/behavior-types">BehaviorTypes</a>.Filter</p>
          </td>
          <td class="column-auto">
