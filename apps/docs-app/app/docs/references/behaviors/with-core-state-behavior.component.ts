...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Core behavior responsible for committing resolved pipeline outcomes into state.<br/><br/>
...
<section class="section">
        ...
        <li>key: string</li><li>behaviorCtx: <a href="/docs/references/contexts/behavior-class-context">BehaviorClassContext</a></li>
                  ...
                  <p>implements:</p>
        <ul>
          <li><a href="/docs/references/contracts/core-state-behavior-contract">CoreStateBehaviorContract</a></li>
        </ul>
                </td>
                <td>
                  Creates a new core state behavior instance.<br/><br/>
                </td>
              </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            Commits partial state changes and emits a single state snapshot event.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Emits a terminal destroy state snapshot.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>err: <a href="/docs/references/shapes/vault-error-shape">VaultErrorShape</a> | null</li><li>ctx: <a href="/docs/references/contexts/behavior-context">BehaviorContext</a></li>
          </ul>
            <p>returns: void</p>
          </td>
          <td>
            Finalizes state when a pipeline error occurs.<br/><br/>
          </td>
        </tr><tr>
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>value: <a href="/docs/references/types/final-state">FinalState</a></li><li>ctx: <a href="/docs/references/contexts/behavior-context">BehaviorContext</a></li>
          </ul>
            <p>returns: void</p>
          </td>
          <td>
          ...
          <ul>
           <li>ctx: <a href="/docs/references/contexts/behavior-context">BehaviorContext</a></li>
            ...
            <p>returns: <a href="/docs/references/types/state-input-type">StateInputType</a> | unknown | unknown</p>
          </td>
          <td>
            Prepares incoming pipeline input and emits an initial incoming state.<br/><br/>
          </td>
        </tr><tr>
          <td>
            <strong>reset</strong>
          ...
          <td>
            Emits a terminal reset state snapshot.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-300">
            ...
            <p class="default">default: <a href="/docs/pipeline/behaviors/state/with-core-state-behavior">withCoreStateBehavior</a>.critical</p>
          </td>
          <td class="column-auto">
          ...
          <td class="column-300">
            ...
            <p class="modifiers">readonly</p>
            <p class="type">type: unknown</p>
            <p class="default">default: <a href="/docs/pipeline/behaviors/state/with-core-state-behavior">withCoreStateBehavior</a>.type</p>
          </td>
          <td class="column-auto">
