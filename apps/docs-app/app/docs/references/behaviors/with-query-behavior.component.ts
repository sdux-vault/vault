...
@Component({
  ...
  template: `<div class="docs-container">
      <div class="header">
        <h3>withQueryBehavior</h3>
      </div>
      <header class="docs-header">
        <div class="lead"><a href="/docs/references/functions/feature-cell">FeatureCell</a> extension behavior that provides entity query capabilities.<br/><br/>
This behavior maintains a local cache of entities observed through state
emissions and exposes query APIs for resolving entities by identifier.<br/><br/>
Unlike lookup behavior, query behavior never triggers fetches or submits
pipeline work. It only reflects entities that have already entered state.<br/><br/></div>
...
<section class="section">
        ...
        <ul>
          <li><a href="/docs/references/contracts/behavior-contract">BehaviorContract</a></li>
                ...
                <td>
                  Creates a new query behavior instance.<br/><br/>
                </td>
              </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            Normalizes a state value into an array of entities for cache indexing.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Extends the <a href="/docs/references/functions/feature-cell">FeatureCell</a> with the query subscription and lookup API.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Registers the fluent withQuery configuration method on the <a href="/docs/references/functions/feature-cell">FeatureCell</a>.<br/><br/>
          </td>
        </tr><tr>
          <td>
            <strong>reset</strong>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-300">
            ...
            <p class="type">type: <a href="/docs/references/options/query-behavior-options">QueryBehaviorOptions</a></p>
            
          </td>
          <td class="column-auto">
            Resolved query configuration options for this behavior instance.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
          ...
          <td class="column-auto">
            Configuration key used to locate query options in the config registry.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
          ...
          <td class="column-300">
            ...
            <p class="modifiers">readonly</p>
            <p class="type">type: unknown</p>
            <p class="default">default: <a href="/docs/pipeline/addons/entity-access/with-query-behavior">withQueryBehavior</a>.critical</p>
          </td>
          <td class="column-auto">
          ...
          <td class="column-auto">
            Extension function that registers the query API on the <a href="/docs/references/functions/feature-cell">FeatureCell</a>.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>key</strong>
          ...
          <td class="column-300">
            ...
            <p class="modifiers">readonly</p>
            <p class="type">type: unknown</p>
            <p class="default">default: <a href="/docs/pipeline/addons/entity-access/with-query-behavior">withQueryBehavior</a>.type</p>
          </td>
          <td class="column-auto">
