...
@Component({
  ...
  template: `<div class="docs-container">
    <div class="header">
      <h2>
        <a href="/docs/pipeline/behaviors/vault/with-tab-sync-state-behavior"
          >withTabSyncStateBehavior</a
        >
      </h2>
    </div>
    <header class="docs-header">
      <div class="lead">
        Cross-tab state synchronization behavior that extends core state
        management.<br /><br />
        This behavior broadcasts finalized state snapshots to other browser tabs
        via BroadcastChannel and applies incoming snapshots from other tabs
        directly to the local state without triggering the pipeline. It requires
        a valid license and is opt-in per
        ...
        <table aria-label="Methods">
          ...
          <tbody>
            <tr>
              ...
              <td>
                Closes the BroadcastChannel and stops listening for cross-tab
                messages.<br /><br />
              </td>
            </tr>
            <tr>
              <td>
                ...
                <p>inputs:</p>
                <ul>
                  <li>message: TabSyncMessageShape</li>
                  <li>
                    ctx:
              ...
              <td>
                Handles an incoming cross-tab message and commits or caches the
                snapshot.<br /><br />
              </td>
            </tr>
            <tr>
              ...
              <td>
                Opens the BroadcastChannel and begins listening for cross-tab
                messages.<br /><br />
              </td>
            </tr>
            <tr>
              ...
              <td>
                Subscribes to commands from the tab sync controller via the
                bus.<br /><br />
              </td>
            </tr>
            <tr>
              ...
              <td>
                Extends commitState to broadcast finalized snapshots to other
                tabs.<br /><br />
              </td>
            </tr>
            <tr>
              ...
              <td>
                Emits a terminal destroy state snapshot and closes the
                channel.<br /><br />
              </td>
            </tr>
            <tr>
              ...
              <td>
                Emits a terminal reset state snapshot while keeping the channel
                open.<br /><br />
              </td>
            </tr>
          </tbody>
            ...
            <tr>
              <td class="column-300">
                ...
                <p class="default">
                  default:
                  <a
                    href="/docs/pipeline/behaviors/vault/with-tab-sync-state-behavior"
                    >withTabSyncStateBehavior</a
                  >.critical
                </p>
              </td>
