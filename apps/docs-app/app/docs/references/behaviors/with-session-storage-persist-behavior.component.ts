...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">SessionStorage persistence behavior that writes and restores <a href="/docs/references/functions/feature-cell">FeatureCell</a> state
...
<section class="section">
        ...
        <li>key: string</li><li>behaviorCtx: <a href="/docs/references/contexts/behavior-class-context">BehaviorClassContext</a></li>
                  ...
                  <p>implements:</p>
        <ul>
          <li><a href="/docs/references/contracts/persist-behavior-contract">PersistBehaviorContract</a></li>
        </ul>
                </td>
                <td>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            Clears the stored state by removing the associated sessionStorage entry.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Teardown hook invoked when the <a href="/docs/references/functions/feature-cell">FeatureCell</a> is destroyed.<br/><br/>
          </td>
        </tr><tr>
          <td>
            ...
            <p>returns: <a href="/docs/references/types/pipeline-persist-value">PipelinePersistValue</a>&lt;T&gt;</p>
          </td>
          <td>
            Loads state from sessionStorage, returning undefined when missing or invalid.<br/><br/>
          </td>
        </tr><tr>
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>current: <a href="/docs/references/types/pipeline-persist-value">PipelinePersistValue</a></li>
          </ul>
            <p>returns: void</p>
          </td>
          <td>
            Persists state into the browser sessionStorage, or removes the entry when undefined.<br/><br/>
          </td>
        </tr><tr>
          <td>
            <strong>reset</strong>
          ...
          <td>
            Resets the persisted sessionStorage entry for this <a href="/docs/references/functions/feature-cell">FeatureCell</a>.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            Fully qualified sessionStorage key used to store this <a href="/docs/references/functions/feature-cell">FeatureCell</a>’s data.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
          ...
          <td class="column-auto">
            Indicates this behavior is not critical to pipeline execution.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>critical</strong>
          ...
          <td class="column-auto">
            Indicates whether this behavior instance is critical to pipeline execution.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>key</strong>
          ...
          <td class="column-300">
            ...
            <p class="modifiers">readonly</p>
            <p class="type">type: unknown</p>
            <p class="default">default: <a href="/docs/references/const/behavior-types">BehaviorTypes</a>.Persist</p>
          </td>
          <td class="column-auto">
