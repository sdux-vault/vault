...
@Component({
  ...
  template: `<div class="docs-container">
    ...
    <header class="docs-header">
      <div class="lead">
        Interceptor behavior that pauses state propagation when a global error
        signal is active.<br /><br />
        This behavior monitors the global error service and conditionally blocks
        incoming state updates at the interceptor stage when an error is
        present. When no global error exists, incoming state is passed through
        unchanged. The interceptor is non-critical and does not modify state
        values directly.<br /><br />
      </div>
    </header>
            ...
            <tr>
              <td>
                ...
                <ul>
                  <li>
                    <a
                      href="/docs/references/contracts/interceptor-behavior-contract"
                      >InterceptorBehaviorContract</a
                    >
                  </li>
                </ul>
              </td>
              <td>
                Creates a new interceptor instance that observes the global
                error service.<br /><br />
              </td>
            </tr>
          </tbody>
          ...
          <tbody>
            <tr>
              <td>
                ...
                <p>
                  returns: Promise&lt;<a
                    href="/docs/references/types/interceptor-state-type"
                    >InterceptorStateType</a
                  >&lt;T&gt;&gt;
                </p>
              </td>
              <td>
                Conditionally blocks incoming state updates when a global error
                is active.<br /><br />
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>Resets the interceptor to its initial state.<br /><br /></td>
            </tr>
          </tbody>
        </table>
      </div>
        ...
        <table aria-label="Properties">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="column-auto">
                Indicates that this behavior is non-critical within the
                pipeline.<br /><br />
              </td>
            </tr>
            <tr>
              ...
              <td class="column-auto">
                Instance-level criticality flag inherited from the static
                definition.<br /><br />
              </td>
            </tr>
            <tr>
