...
@Component({
  ...
  template: `<div class="docs-container">
    <div class="header">
      <h2>
        <a href="/docs/pipeline/behaviors/reducer/with-core-reducer-behavior"
          >withCoreReducerBehavior</a
        >
      </h2>
    </div>
    <header class="docs-header">
      <div class="lead">
        Core reducer behavior that applies pure reducer functions to state
        values.<br /><br />
        ...
        beyond ensuring the reducer is callable.<br /><br />
      </div>
    </header>
            ...
            <tr>
              <td>
                ...
                <ul>
                  <li>
                    <a
                      href="/docs/references/contracts/reduce-behavior-contract"
                      >ReduceBehaviorContract</a
                    >
                  </li>
                </ul>
              </td>
              <td>Creates a new reducer behavior instance.<br /><br /></td>
            </tr>
          </tbody>
        </table>
      </div>
