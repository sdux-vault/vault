...
@Component({
  ...
  template: `<div class="docs-container">
      <div class="header">
        <h3>withObjectDeepMergeBehavior</h3>
      </div>
      <header class="docs-header">
        <div class="lead">Deep merge behavior used to combine nested state objects in the Vault pipeline.<br/><br/>
...
as conditional clearing of undefined values and optional removal of null fields.<br/><br/>
Deep merge is useful for complex feature states that evolve through patch-style
updates across multiple nested levels.<br/><br/>
This behavior is marked critical, ensuring that a merge strategy is always
present during pipeline execution.<br/><br/></div>
...
<section class="section">
        ...
        <ul>
          <li><a href="/docs/references/contracts/merge-behavior-contract">MergeBehaviorContract</a></li>
                ...
                <td>
                  Creates a new deep-merge behavior instance.<br/><br/>
                </td>
              </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>target: any</li><li>incoming: any</li>
          </ul>
            <p>returns: any</p>
          </td>
          <td>
...
class instances are treated as replaceable values and are not traversed.<br/><br/>
The method constructs a new output object and does not mutate either input.<br/><br/>
          </td>
        </tr><tr>
          <td>
...
structured objects are excluded.<br/><br/>
          </td>
        </tr><tr>
          <td>
...
entirely if all nested values evaluate to null.<br/><br/>
This method does not modify the input and returns a new cleaned structure.<br/><br/>
          </td>
        </tr><tr>
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>currentValue: <a href="/docs/references/types/pipeline-upstream-value">PipelineUpstreamValue</a> | undefined</li><li>nextValue: <a href="/docs/references/types/pipeline-upstream-value">PipelineUpstreamValue</a> | undefined</li><li>options?: <a href="/docs/references/config/object-deep-merge-config">ObjectDeepMergeConfig</a></li>
          </ul>
            <p>returns: <a href="/docs/references/types/pipeline-upstream-value">PipelineUpstreamValue</a> | undefined</p>
          </td>
          <td>
            Computes a deep merge between the current and next pipeline values.<br/><br/>
...
current value and enables removal of null fields from merged output.<br/><br/>
          </td>
        </tr><tr>
          <td>
...
This behavior maintains no internal resources and performs no cleanup.<br/><br/>
          </td>
        </tr><tr>
          <td>
            <strong>reset</strong>
...
diagnostic visibility within DevTools.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-300">
            ...
            <p class="default">default: <a href="/docs/pipeline/addons/merge/with-object-deep-merge-behavior">withObjectDeepMergeBehavior</a>.critical</p>
          </td>
          <td class="column-auto">
            Indicates this behavior is required to run within the merge stage.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>key</strong>
          ...
          <td class="column-auto">
            Static metadata used by the orchestrator to classify this behavior.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>type</strong>
            <p class="modifiers">readonly</p>
            <p class="type">type: unknown</p>
            <p class="default">default: <a href="/docs/pipeline/addons/merge/with-object-deep-merge-behavior">withObjectDeepMergeBehavior</a>.type</p>
          </td>
          <td class="column-auto">
