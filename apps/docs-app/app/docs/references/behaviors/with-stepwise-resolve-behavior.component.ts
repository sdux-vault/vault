...
@Component({
  ...
  template: `<div class="docs-container">
      <div class="header">
        <h3>withStepwiseResolveBehavior</h3>
      </div>
      <header class="docs-header">
        <div class="lead">Stepwise resolve behavior that evaluates candidate state values against a
stepwise policy before allowing resolve-stage execution to proceed.<br/><br/>
This behavior operates at the resolve stage and delegates decision-making to
a consumer-supplied stepwise callback configured through the <a href="/docs/references/functions/feature-cell">FeatureCell</a> API.<br/><br/></div>
...
<section class="section">
        ...
        <li>key: string</li><li>_behaviorCtx: <a href="/docs/references/contexts/behavior-class-context">BehaviorClassContext</a></li>
                ...
                <td>
                  Creates a new stepwise resolve behavior instance bound to the resolve stage.<br/><br/>
                </td>
              </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            Installs the fluent API method used to configure stepwise resolve behavior on a <a href="/docs/references/functions/feature-cell">FeatureCell</a>.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            Extension function used to augment the <a href="/docs/references/functions/feature-cell">FeatureCell</a> API with stepwise resolve configuration.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
