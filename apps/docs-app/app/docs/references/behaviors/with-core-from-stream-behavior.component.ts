...
@Component({
  ...
  template: `<div class="docs-container">
    ...
    <header class="docs-header">
      <div class="lead">
        Observable-based resolve behavior that subscribes to a consumer-supplied
        stream and merges emitted values into the
        ...
        <table aria-label="Constructor">
          ...
          <tbody>
            <tr>
              ...
              <td>Creates a new fromStream behavior instance.<br /><br /></td>
            </tr>
          </tbody>
        </table>
      </div>
            ...
            <tr>
              <td>
                ...
                <p>
                  returns:
                  <a
                    href="/docs/references/interfaces/from-stream-behavior-extension"
                    >FromStreamBehaviorExtension</a
                  >
                </p>
              </td>
              <td>
                ...
                <a href="/docs/references/functions/feature-cell"
                  >FeatureCell</a
                >
                with the fromStream subscription API.<br /><br />
              </td>
            </tr>
            <tr>
              <td>
        ...
        <table aria-label="Properties">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="column-auto">
                Extension function used to register the fromStream API on the
