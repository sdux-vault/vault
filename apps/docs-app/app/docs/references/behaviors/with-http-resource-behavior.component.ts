...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Resolve behavior that extracts state values from an Angular HTTP resource reference.<br/><br/>
...
the resource emits a concrete value or error.<br/><br/></div>
...
<section class="section">
        ...
        <li>key: string</li><li>behaviorCtx: <a href="/docs/references/contexts/behavior-class-context">BehaviorClassContext</a></li>
                  ...
                  <p>implements:</p>
        <ul>
          <li><a href="/docs/references/contracts/resolve-behavior-contract">ResolveBehaviorContract</a></li>
        </ul>
                </td>
                <td>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            Resolves a pipeline value from an HTTP resource reference when supported.<br/><br/>
          </td>
        </tr><tr>
          <td>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            Indicates that this resolve behavior is required for pipeline execution.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>critical</strong>
            ...
            <p class="default">default: <a href="/docs/pipeline/behaviors/resolve/with-http-resource-behavior">withHttpResourceBehavior</a>.critical</p>
          </td>
          <td class="column-auto">
            Indicates that this behavior is critical in the resolve stage.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>key</strong>
          ...
          <td class="column-300">
            ...
            <p class="type">type: unknown</p>
            <p class="default">default: <a href="/docs/pipeline/behaviors/resolve/with-http-resource-behavior">withHttpResourceBehavior</a>.resolveType</p>
          </td>
          <td class="column-auto">
          ...
          <td class="column-auto">
            Static behavior type metadata used for pipeline classification.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>type</strong>
            <p class="modifiers">readonly</p>
            <p class="type">type: unknown</p>
            <p class="default">default: <a href="/docs/pipeline/behaviors/resolve/with-http-resource-behavior">withHttpResourceBehavior</a>.type</p>
          </td>
          <td class="column-auto">
