...
@Component({
  ...
  template: `<div class="docs-container">
    ...
    <header class="docs-header">
      <div class="lead">
        Extension behavior that enables promise-based state resolution for
        FeatureCells.<br /><br />
        This behavior augments a
        <a href="/docs/references/functions/feature-cell">FeatureCell</a> with
        APIs that accept deferred factories and resolve their produced values
        into normalized state inputs. It supports both promise and deferred
        invocation semantics while preserving pipeline loading and error
        metadata.<br /><br />
        This API exists as a migration bridge for deferred- and promise-based
        workflows. Prefer using replaceState or mergeState to resolve promises
        ...
        <table aria-label="Methods">
          ...
          <tbody>
            <tr>
              ...
              <td>Invoked during behavior teardown.<br /><br /></td>
            </tr>
            <tr>
              <td>
                ...
                <p>
                  returns:
                  <a
                    href="/docs/references/interfaces/from-promise-behavior-extension"
                    >FromPromiseBehaviorExtension</a
                  >
                </p>
              </td>
              <td>
                ...
                <a href="/docs/references/functions/feature-cell"
                  >FeatureCell</a
                >
                API with promise-based resolution functions.<br /><br />
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>Resets the behavior state.<br /><br /></td>
            </tr>
          </tbody>
        </table>
      </div>
        ...
        <table aria-label="Properties">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="column-auto">
                Static behavior function used to extend the
                <a href="/docs/references/functions/feature-cell"
                  >FeatureCell</a
                >
                API.<br /><br />
