...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Merge behavior that appends a single incoming value to an existing array state.<br/><br/>
...
supporting optional clearing of undefined values via merge configuration.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>currentValue: <a href="/docs/references/types/pipeline-upstream-value">PipelineUpstreamValue</a></li><li>nextValue: <a href="/docs/references/types/pipeline-upstream-value">PipelineUpstreamValue</a></li>
          </ul>
            <p>returns: void</p>
          </td>
          <td>
            Emits a warning when non-array values are encountered during merge.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Computes the merged result by appending the incoming value to the current array.<br/><br/>
          </td>
        </tr><tr>
          <td>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            Indicates whether the runtime is operating in development mode.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
          ...
          <td class="column-auto">
            Indicates whether the behavior is critical at the static level.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>critical</strong>
            ...
            <p class="type">type: unknown</p>
            <p class="default">default: <a href="/docs/pipeline/addons/merge/with-array-push-merge-behavior">withArrayPushMergeBehavior</a>.critical</p>
          </td>
          <td class="column-auto">
          ...
          <td class="column-auto">
            Static behavior type identifier used for pipeline classification.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>type</strong>
            <p class="modifiers">readonly</p>
            <p class="type">type: unknown</p>
            <p class="default">default: <a href="/docs/pipeline/addons/merge/with-array-push-merge-behavior">withArrayPushMergeBehavior</a>.type</p>
          </td>
          <td class="column-auto">
