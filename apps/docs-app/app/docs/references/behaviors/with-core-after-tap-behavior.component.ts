...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Core tap behavior executed after reducer completion.<br/><br/>
...
shared tap abstraction and does not modify pipeline state.<br/><br/></div>
...
does not influence pipeline control flow or state resolution.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-300">
            ...
            <p class="default">default: <a href="/docs/references/const/behavior-types">BehaviorTypes</a>.CoreAfterTap</p>
          </td>
          <td class="column-auto">
            Pipeline behavior type indicating execution occurs after reducers.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
