...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">LocalStorage persistence behavior that writes and restores <a href="/docs/references/functions/feature-cell">FeatureCell</a> state
using the browser localStorage API.<br/><br/>
State persists across browser sessions until explicitly cleared or removed.
This behavior runs during the persist stage of the Vault pipeline.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            Clears the stored state by removing the associated localStorage entry.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Loads state from localStorage, returning undefined when missing or invalid.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Persists state into the browser localStorage, or removes the entry when undefined.<br/><br/>
          </td>
        </tr><tr>
          <td>
            <strong>reset</strong>
          ...
          <td>
            Resets the persisted localStorage entry for this <a href="/docs/references/functions/feature-cell">FeatureCell</a>.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            Fully namespaced localStorage key for this <a href="/docs/references/functions/feature-cell">FeatureCell</a>.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
