...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Core resolve behavior that extracts a value from a deferred promise factory.<br/><br/>
...
the pipeline error handling contract.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-300">
            ...
            <p class="default">default: <a href="/docs/pipeline/behaviors/resolve/with-core-promise-behavior">withCorePromiseBehavior</a>.critical</p>
          </td>
          <td class="column-auto">
          ...
          <td class="column-300">
            ...
            <p class="modifiers">readonly</p>
            <p class="type">type: unknown</p>
            <p class="default">default: <a href="/docs/pipeline/behaviors/resolve/with-core-promise-behavior">withCorePromiseBehavior</a>.resolveType</p>
          </td>
          <td class="column-auto">
          ...
          <td class="column-300">
            ...
            <p class="modifiers">readonly</p>
            <p class="type">type: unknown</p>
            <p class="default">default: <a href="/docs/pipeline/behaviors/resolve/with-core-promise-behavior">withCorePromiseBehavior</a>.type</p>
          </td>
          <td class="column-auto">
