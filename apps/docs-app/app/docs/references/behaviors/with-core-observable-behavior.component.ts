...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Core resolve behavior that extracts a single value from an RxJS Observable.<br/><br/>
...
value. Resolution is automatically terminated when the <a href="/docs/references/functions/feature-cell">FeatureCell</a> is reset
or destroyed.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-300">
            ...
            <p class="modifiers">readonly</p>
            <p class="type">type: unknown</p>
            <p class="default">default: <a href="/docs/pipeline/behaviors/resolve/with-core-observable-behavior">withCoreObservableBehavior</a>.resolveType</p>
          </td>
          <td class="column-auto">
          ...
          <td class="column-300">
            ...
            <p class="modifiers">readonly</p>
            <p class="type">type: unknown</p>
            <p class="default">default: <a href="/docs/references/const/behavior-types">BehaviorTypes</a>.Resolve</p>
          </td>
          <td class="column-auto">
