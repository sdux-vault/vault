...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Stepwise reducer behavior that evaluates candidate state values against a stepwise
policy before allowing reducer execution to proceed.<br/><br/>
This behavior operates at the reducer stage and delegates decision-making to a
consumer-supplied stepwise callback configured through the <a href="/docs/references/functions/feature-cell">FeatureCell</a> fluent API.<br/><br/></div>
...
<section class="section">
        ...
        <li>key: string</li><li>_behaviorCtx: <a href="/docs/references/contexts/behavior-class-context">BehaviorClassContext</a></li>
                ...
                <td>
                  Creates a new stepwise reducer behavior instance bound to the reducer stage.<br/><br/>
                </td>
              </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            Installs the fluent API method used to configure stepwise reducer behavior on a <a href="/docs/references/functions/feature-cell">FeatureCell</a>.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            Extension function used to augment the <a href="/docs/references/functions/feature-cell">FeatureCell</a> API with stepwise reducer configuration.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
