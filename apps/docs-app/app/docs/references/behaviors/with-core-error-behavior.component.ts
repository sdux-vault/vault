...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Core error behavior used internally by the Vault orchestrator.<br/><br/>
...
- Guarantee error normalization before transformations occur<br/><br/>
All richer behaviors (mapping, retries, notifications, old-school callbacks)
are implemented as addon error behaviors layered after this one.<br/><br/></div>
...
<section class="section">
        ...
        <li>key: string</li><li>behaviorCtx: <a href="/docs/references/contexts/behavior-class-context">BehaviorClassContext</a></li>
                  ...
                  <p>implements:</p>
        <ul>
          <li><a href="/docs/references/contracts/core-error-behavior-contract">CoreErrorBehaviorContract</a></li>
        </ul>
                </td>
                <td>
...
stores metadata required by the orchestrator and devtools.<br/><br/>
                </td>
              </tr>
            </tbody>
          </table>
...
with behavior lifecycle introspection.<br/><br/>
          </td>
        </tr><tr>
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>error: unknown</li><li>featureCellKey: string</li>
          </ul>
            <p>returns: <a href="/docs/references/shapes/vault-error-shape">VaultErrorShape</a></p>
          </td>
          <td>
            Normalizes an unknown error into a &#123;&#64;link <a href="/docs/references/shapes/vault-error-shape">VaultErrorShape</a>&#125;.<br/><br/>
...
devtools state introspection.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            Indicates this behavior participates critically in the pipeline.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>critical</strong>
          ...
          <td class="column-auto">
            Indicates that this error behavior is critical and always executed.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>key</strong>
          ...
          <td class="column-300">
            ...
            <p class="modifiers">readonly</p>
            <p class="type">type: unknown</p>
            <p class="default">default: <a href="/docs/references/const/behavior-types">BehaviorTypes</a>.CoreError</p>
          </td>
          <td class="column-auto">
