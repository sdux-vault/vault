...
@Component({
  ...
  template: `<div class="docs-container">
      <div class="header">
        <h3>withCookieStoragePersistBehavior</h3>
      </div>
      <header class="docs-header">
        <div class="lead">Cookie-based persistence behavior that writes and restores <a href="/docs/references/functions/feature-cell">FeatureCell</a> state
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            Clears the cookie associated with this <a href="/docs/references/functions/feature-cell">FeatureCell</a>.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Loads state from the cookie, returning undefined when missing or invalid.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Persists state into a cookie, or removes the cookie when undefined.<br/><br/>
          </td>
        </tr><tr>
          <td>
            <strong>reset</strong>
          ...
          <td>
            Resets the persisted cookie entry for this <a href="/docs/references/functions/feature-cell">FeatureCell</a>.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            Fully namespaced cookie key for this <a href="/docs/references/functions/feature-cell">FeatureCell</a>.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
