...
@Component({
  ...
  template: `<div class="docs-container">
      <div class="header">
        <h3>withCoreFromObservableBehavior</h3>
      </div>
      <header class="docs-header">
        <div class="lead">Extension behavior that enables FeatureCells to resolve state from observable sources.<br/><br/>
This behavior augments the <a href="/docs/references/functions/feature-cell">FeatureCell</a> API with a fromObservable method that
converts a single observable emission into a normalized state envelope and
binds subscription lifetime to the cell lifecycle.<br/><br/>
This API exists as a migration bridge for observable-based workflows.
Prefer using replaceState or mergeState to resolve
observables directly within the pipeline.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          This API exists as a migration bridge for observable-based workflows.
Prefer using replaceState or mergeState to resolve
observables directly within the pipeline.<br/><br/>
        </div>
      </section>
<section class="section">
        ...
        <div class="section-body">
          ...
          <ul>
           <li>ctx: <a href="/docs/references/contexts/feature-cell-extension-context">FeatureCellExtensionContext</a></li>
            ...
            <p>returns: <a href="/docs/references/interfaces/from-observable-behavior-extension">FromObservableBehaviorExtension</a></p>
          </td>
          <td>
            Extends the <a href="/docs/references/functions/feature-cell">FeatureCell</a> API with observable-based resolution support.<br/><br/>
          </td>
        </tr><tr>
          <td>
            <strong>reset</strong>
          ...
          <td>
            Resets the observable extension behavior.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-300">
            ...
            <p class="default">default: <a href="/docs/pipeline/behaviors/observable/with-core-from-observable-behavior">withCoreFromObservableBehavior</a>.critical</p>
          </td>
          <td class="column-auto">
          ...
          <td class="column-auto">
            Extension function used to attach observable APIs to the <a href="/docs/references/functions/feature-cell">FeatureCell</a>.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>key</strong>
          ...
          <td class="column-300">
            ...
            <p class="modifiers">readonly</p>
            <p class="type">type: unknown</p>
            <p class="default">default: <a href="/docs/pipeline/behaviors/observable/with-core-from-observable-behavior">withCoreFromObservableBehavior</a>.resolveType</p>
          </td>
          <td class="column-auto">
          ...
          <td class="column-300">
            ...
            <p class="modifiers">readonly</p>
            <p class="type">type: unknown</p>
            <p class="default">default: <a href="/docs/pipeline/behaviors/observable/with-core-from-observable-behavior">withCoreFromObservableBehavior</a>.type</p>
          </td>
          <td class="column-auto">
