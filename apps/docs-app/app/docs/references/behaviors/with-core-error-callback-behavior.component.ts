...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Core error callback behavior for invoking legacy error handlers.<br/><br/>
...
snapshot of the <a href="/docs/references/functions/feature-cell">FeatureCell</a> state without altering error flow.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>current: <a href="/docs/references/shapes/vault-error-shape">VaultErrorShape</a></li><li>state: <a href="/docs/references/shapes/state-snapshot-shape">StateSnapshotShape</a></li><li>oldschoolCallback: <a href="/docs/references/types/vault-error-callback">VaultErrorCallback</a></li>
          </ul>
            <p>returns: Promise&lt;void&gt;</p>
          </td>
          <td>
            Invokes a legacy error callback with the normalized error and state snapshot.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-300">
            ...
            <p class="default">default: <a href="/docs/pipeline/behaviors/error/with-core-error-callback-behavior">withCoreErrorCallbackBehavior</a>.critical</p>
          </td>
          <td class="column-auto">
            Indicates that this error callback behavior is always executed.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>key</strong>
          ...
          <td class="column-auto">
            Static behavior type identifier used for orchestrator classification.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
