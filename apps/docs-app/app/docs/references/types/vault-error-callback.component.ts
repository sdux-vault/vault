...
@Component({
  ...
  template: `<div class="docs-container">
    ...
    <header class="docs-header">
      <div class="lead">
        Callback function signature used for observing errors emitted during the
        <a href="/docs/references/functions/feature-cell">FeatureCell</a>
        error-handling pipeline. An ErrorCallback receives the normalized
        &#123;&#64;link
        <a href="/docs/references/shapes/vault-error-shape">VaultErrorShape</a
        >&#125; produced by the pipeline and a read-only &#123;&#64;link
        ...
        state at the time the error occurred. This callback type performs no
        transformation of the pipeline value; implementations are expected to
        execute side effects only, such as logging or reporting. Returning a
        value has no effect on pipeline behavior.<br /><br />
      </div>
    </header>
