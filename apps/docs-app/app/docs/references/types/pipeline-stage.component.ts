 ...
 * Symbol: <a href="/docs/references/types/pipeline-stage">PipelineStage</a>
 */
...
@Component({
  selector: 'sdux-pipeline-stage',
  standalone: true,
  imports: [BrandNameComponent, PackageNameComponent],
  template: `<div class="docs-container">
    <div class="header">
      <h2><a href="/docs/references/types/pipeline-stage">PipelineStage</a></h2>
    </div>
    <header class="docs-header">
      <div class="lead">
        Union type derived from
        <a href="/docs/references/const/pipeline-stages">PipelineStages</a>
        values.<br /><br />
      </div>
    </header>
