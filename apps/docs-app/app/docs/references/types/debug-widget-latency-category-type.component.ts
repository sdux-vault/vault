 ...
 * Symbol: <a href="/docs/references/types/debug-widget-latency-category-type">DebugWidgetLatencyCategoryType</a>
 */

import { Component, ViewEncapsulation } from '@angular/core';

@Component({
  selector: 'sdux-debug-widget-latency-category-type',
  standalone: true,
  template: `<div class="docs-container">
      <div class="header">
        <h3>DebugWidgetLatencyCategoryType</h3>
      </div>
      <header class="docs-header">
        <div class="lead">Union of valid latency category values.<br/><br/></div>
...
<section class="section">
      ...
      <div class="section-body">
        <p>
          <strong><a href="/docs/references/types/debug-widget-latency-category-type">DebugWidgetLatencyCategoryType</a></strong> is a derived type alias.
        </p>
        <p>
...
export class DebugWidgetLatencyCategoryTypeComponent {}
