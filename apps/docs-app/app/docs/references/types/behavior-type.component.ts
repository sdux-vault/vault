...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Union of all valid behavior type strings.
This type is derived from <a href="/docs/references/const/behavior-types">BehaviorTypes</a> using literal inference, ensuring
strong typing while preserving full runtime compatibility.
This type should not be manually extended—add new values to <a href="/docs/references/const/behavior-types">BehaviorTypes</a>
instead.<br/><br/></div>
...
<section class="section">
      ...
      <div class="section-body">
        <p>
          <strong><a href="/docs/references/types/behavior-type">BehaviorType</a></strong> is a derived type alias.
        </p>
        <p>
