...
@Component({
  ...
  template: `<div class="docs-container">
    <div class="header">
      <h2><a href="/docs/references/types/resolve-type">ResolveType</a></h2>
    </div>
    <header class="docs-header">
      <div class="lead">
        Union type representing all supported resolve strategy identifiers.<br /><br />
      </div>
    </header>
    ...
    <section class="section">
      ...
      <div class="section-body">
        <p>
          <strong
            ><a href="/docs/references/types/resolve-type"
              >ResolveType</a
            ></strong
          >
