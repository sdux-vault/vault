 ...
 * Symbol: <a href="/docs/references/types/resolve-type">ResolveType</a>
 */

import { Component, ViewEncapsulation } from '@angular/core';

@Component({
  selector: 'sdux-resolve-type',
  standalone: true,
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Union type representing all supported resolve strategy identifiers.<br/><br/></div>
...
<section class="section">
      ...
      <div class="section-body">
        <p>
          <strong><a href="/docs/references/types/resolve-type">ResolveType</a></strong> is a derived type alias.
        </p>
        <p>
...
export class ResolveTypeComponent {}
