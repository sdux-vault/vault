 ...
 * Symbol: <a href="/docs/references/types/vault-registration-license-status-type">VaultRegistrationLicenseStatusType</a>
 */
...
@Component({
  selector: 'sdux-vault-registration-license-status-type',
  standalone: true,
  imports: [BrandNameComponent, PackageNameComponent],
  template: `<div class="docs-container">
    <div class="header">
      <h2>
        <a href="/docs/references/types/vault-registration-license-status-type"
...
export class VaultRegistrationLicenseStatusTypeComponent {}
