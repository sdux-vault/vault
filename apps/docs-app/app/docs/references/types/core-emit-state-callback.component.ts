 ...
 * Symbol: <a href="/docs/references/types/core-emit-state-callback">CoreEmitStateCallback</a>
 */

import { Component, ViewEncapsulation } from '@angular/core';

@Component({
  selector: 'sdux-core-emit-state-callback',
  standalone: true,
  template: `<div class="docs-container">
      <div class="header">
        <h3>CoreEmitStateCallback</h3>
      </div>
      <header class="docs-header">
        <div class="lead">Callback type invoked when the core emits a state snapshot.<br/><br/></div>
...
type CoreEmitStateCallback = function;
          </code></pre>
        </div>
      </section>
      <section class="section">
...
export class CoreEmitStateCallbackComponent {}
