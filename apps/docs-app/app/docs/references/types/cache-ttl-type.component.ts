 ...
 * Symbol: <a href="/docs/references/types/cache-ttl-type">CacheTTLType</a>
 */
...
@Component({
  ...
  template: `<div class="docs-container">
    <div class="header">
      <h2><a href="/docs/references/types/cache-ttl-type">CacheTTLType</a></h2>
    </div>
...
export class CacheTTLTypeComponent {}
