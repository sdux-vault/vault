 ...
 * Symbol: <a href="/docs/references/types/debug-widget-event-instant-scope-type">DebugWidgetEventInstantScopeType</a>
 */

import { Component, ViewEncapsulation } from '@angular/core';

@Component({
  selector: 'sdux-debug-widget-event-instant-scope-type',
  standalone: true,
  template: `<div class="docs-container">
      <div class="header">
        <h3>DebugWidgetEventInstantScopeType</h3>
      </div>
      <header class="docs-header">
        <div class="lead">Union of valid instant event scope values.<br/><br/></div>
...
<section class="section">
      ...
      <div class="section-body">
        <p>
          <strong><a href="/docs/references/types/debug-widget-event-instant-scope-type">DebugWidgetEventInstantScopeType</a></strong> is a derived type alias.
        </p>
        <p>
...
export class DebugWidgetEventInstantScopeTypeComponent {}
