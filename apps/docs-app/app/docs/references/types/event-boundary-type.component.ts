 ...
 * Symbol: <a href="/docs/references/types/event-boundary-type">EventBoundaryType</a>
 */

import { Component, ViewEncapsulation } from '@angular/core';

@Component({
  selector: 'sdux-event-boundary-type',
  standalone: true,
  template: `<div class="docs-container">
      <div class="header">
        <h3>EventBoundaryType</h3>
      </div>
      <header class="docs-header">
        <div class="lead">Union type derived from <a href="/docs/references/const/event-boundary-types">EventBoundaryTypes</a> values.<br/><br/></div>
...
<section class="section">
      ...
      <div class="section-body">
        <p>
          <strong><a href="/docs/references/types/event-boundary-type">EventBoundaryType</a></strong> is a derived type alias.
        </p>
        <p>
...
export class EventBoundaryTypeComponent {}
