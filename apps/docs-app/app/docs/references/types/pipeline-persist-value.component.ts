...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Represents the value passed into persistence behaviors.
A <a href="/docs/references/types/pipeline-persist-value">PipelinePersistValue</a>&amp;lt;T&amp;gt; may be:<br/><br/>
T — the final, post-encryption state ready to be persisted
undefined — indicating that no value should be written to storage<br/><br/>
Unlike upstream pipeline values, persistence values never include
<a href="/docs/references/const/vault_noop">VAULT_NOOP</a>, because no-op handling is completed before the persistence
stage begins.<br/><br/></div>
