 ...
 * Symbol: <a href="/docs/references/types/state-emit-type">StateEmitType</a>
 */

import { Component, ViewEncapsulation } from '@angular/core';

@Component({
  selector: 'sdux-state-emit-type',
  standalone: true,
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Union type derived from <a href="/docs/references/const/state-emit-types">StateEmitTypes</a> values.<br/><br/></div>
...
<section class="section">
      ...
      <div class="section-body">
        <p>
          <strong><a href="/docs/references/types/state-emit-type">StateEmitType</a></strong> is a derived type alias.
        </p>
        <p>
...
export class StateEmitTypeComponent {}
