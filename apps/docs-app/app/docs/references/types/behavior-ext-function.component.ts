 ...
 * Symbol: <a href="/docs/references/types/behavior-ext-function">BehaviorExtFunction</a>
 */

import { Component, ViewEncapsulation } from '@angular/core';

@Component({
  selector: 'sdux-behavior-ext-function',
  standalone: true,
  template: `<div class="docs-container">
      <div class="header">
        <h3>BehaviorExtFunction</h3>
      </div>
      <header class="docs-header">
        <div class="lead">Function signature for behavior extension methods added to the <a href="/docs/references/functions/feature-cell">FeatureCell</a>.<br/><br/></div>
...
type BehaviorExtFunction = function;
          </code></pre>
        </div>
      </section>
      <section class="section">
