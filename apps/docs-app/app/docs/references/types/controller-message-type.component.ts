 ...
 * Symbol: <a href="/docs/references/types/controller-message-type">ControllerMessageType</a>
 */

import { Component, ViewEncapsulation } from '@angular/core';

@Component({
  selector: 'sdux-controller-message-type',
  standalone: true,
  template: `<div class="docs-container">
      <div class="header">
        <h3>ControllerMessageType</h3>
      </div>
      <header class="docs-header">
        <div class="lead">Union type derived from <a href="/docs/references/const/controller-message-types">ControllerMessageTypes</a> values.<br/><br/></div>
...
<section class="section">
      ...
      <div class="section-body">
        <p>
          <strong><a href="/docs/references/types/controller-message-type">ControllerMessageType</a></strong> is a derived type alias.
        </p>
        <p>
...
export class ControllerMessageTypeComponent {}
