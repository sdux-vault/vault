...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Defines the callback signature invoked during a stepwise behavior evaluation.
This function receives the current state snapshot, the candidate value under evaluation,
and a decision control object that determines how the pipeline proceeds at the stepwise stage.<br/><br/></div>
