 ...
 * Symbol: <a href="/docs/references/types/log-level-type">LogLevelType</a>
 */

import { Component, ViewEncapsulation } from '@angular/core';

@Component({
  selector: 'sdux-log-level-type',
  standalone: true,
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Union type derived from <a href="/docs/references/const/log-level-types">LogLevelTypes</a> values.<br/><br/></div>
...
<section class="section">
      ...
      <div class="section-body">
        <p>
          <strong><a href="/docs/references/types/log-level-type">LogLevelType</a></strong> is a derived type alias.
        </p>
        <p>
...
export class LogLevelTypeComponent {}
