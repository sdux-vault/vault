 ...
 * Symbol: <a href="/docs/references/types/operation-type">OperationType</a>
 */

import { Component, ViewEncapsulation } from '@angular/core';

@Component({
  selector: 'sdux-operation-type',
  standalone: true,
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Union type derived from <a href="/docs/references/const/operation-types">OperationTypes</a> values.<br/><br/></div>
...
<section class="section">
      ...
      <div class="section-body">
        <p>
          <strong><a href="/docs/references/types/operation-type">OperationType</a></strong> is a derived type alias.
        </p>
        <p>
