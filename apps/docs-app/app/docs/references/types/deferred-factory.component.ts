 ...
 * Symbol: <a href="/docs/references/types/deferred-factory">DeferredFactory</a>
 */
...
@Component({
  selector: 'sdux-deferred-factory',
  standalone: true,
  ...
  template: `<div class="docs-container">
    ...
    <header class="docs-header">
      <div class="lead">
        Shape wrapping a deferred value factory with optional loading and error
        state.<br /><br />
      </div>
    </header>
