 ...
 * Symbol: <a href="/docs/references/types/debug-widget-event-source-type">DebugWidgetEventSourceType</a>
 */

import { Component, ViewEncapsulation } from '@angular/core';

@Component({
  selector: 'sdux-debug-widget-event-source-type',
  standalone: true,
...
<section class="section">
      ...
      <div class="section-body">
        <p>
          <strong><a href="/docs/references/types/debug-widget-event-source-type">DebugWidgetEventSourceType</a></strong> is a derived type alias.
        </p>
        <p>
...
export class DebugWidgetEventSourceTypeComponent {}
