 ...
 * Symbol: <a href="/docs/references/types/behavior-meta-shape">BehaviorMetaShape</a>
 */
...
@Component({
  ...
  template: `<div class="docs-container">
    ...
    <header class="docs-header">
      <div class="lead">
        Metadata describing a registered behavior&amp;#39;s static
        configuration. The behavior type discriminates whether resolveType is
        required or forbidden.<br /><br />
      </div>
    </header>
...
type BehaviorMetaShape = ResolveBehaviorMetaShape | NonResolveBehaviorMetaShape;
          </code></pre>
      </div>
    </section>
