 ...
 * Symbol: <a href="/docs/references/types/vault-error-name-type">VaultErrorNameType</a>
 */

import { Component, ViewEncapsulation } from '@angular/core';

@Component({
  selector: 'sdux-vault-error-name-type',
  standalone: true,
  template: `<div class="docs-container">
      <div class="header">
        <h3>VaultErrorNameType</h3>
      </div>
      <header class="docs-header">
        <div class="lead">Union type derived from <a href="/docs/references/const/vault-error-name-types">VaultErrorNameTypes</a> values.<br/><br/></div>
...
<section class="section">
      ...
      <div class="section-body">
        <p>
          <strong><a href="/docs/references/types/vault-error-name-type">VaultErrorNameType</a></strong> is a derived type alias.
        </p>
        <p>
...
export class VaultErrorNameTypeComponent {}
