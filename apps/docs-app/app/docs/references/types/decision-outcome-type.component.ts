 ...
 * Symbol: <a href="/docs/references/types/decision-outcome-type">DecisionOutcomeType</a>
 */

import { Component, ViewEncapsulation } from '@angular/core';

@Component({
  selector: 'sdux-decision-outcome-type',
  standalone: true,
  template: `<div class="docs-container">
      <div class="header">
        <h3>DecisionOutcomeType</h3>
      </div>
      <header class="docs-header">
        <div class="lead">Union type derived from <a href="/docs/references/const/decision-outcome-types">DecisionOutcomeTypes</a> values.<br/><br/></div>
...
<section class="section">
      ...
      <div class="section-body">
        <p>
          <strong><a href="/docs/references/types/decision-outcome-type">DecisionOutcomeType</a></strong> is a derived type alias.
        </p>
        <p>
...
export class DecisionOutcomeTypeComponent {}
