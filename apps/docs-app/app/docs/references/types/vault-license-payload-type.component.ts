 ...
 * Symbol: <a href="/docs/references/types/vault-license-payload-type">VaultLicensePayloadType</a>
 */
...
@Component({
  selector: 'sdux-vault-license-payload-type',
  standalone: true,
  imports: [BrandNameComponent],
  template: `<div class="docs-container">
    <div class="header">
      <h3>VaultLicensePayloadType</h3>
    </div>
    <header class="docs-header">
      <div class="lead">
        Union type of all Vault license payload values.<br /><br />
      </div>
    </header>
...
export class VaultLicensePayloadTypeComponent {}
