 ...
 * Symbol: <a href="/docs/references/types/tap-callback">TapCallback</a>
 */
...
@Component({
  selector: 'sdux-tap-callback',
  standalone: true,
  imports: [BrandNameComponent, PackageNameComponent],
  template: `<div class="docs-container">
    <div class="header">
      <h2><a href="/docs/references/types/tap-callback">TapCallback</a></h2>
    </div>
    <header class="docs-header">
      <div class="lead">
        Callback type invoked with the current value during a tap lifecycle
        event.<br /><br />
      </div>
    </header>
