 ...
 * Symbol: <a href="/docs/references/types/vault-error-kind-type">VaultErrorKindType</a>
 */
...
@Component({
  selector: 'sdux-vault-error-kind-type',
  standalone: true,
  imports: [BrandNameComponent],
  template: `<div class="docs-container">
    <div class="header">
      <h3>VaultErrorKindType</h3>
    </div>
    <header class="docs-header">
      <div class="lead">
        Union type of all Vault error kind values including usage sub-kinds.<br /><br />
      </div>
    </header>
...
type VaultErrorKindType = unknown | unknown;
          </code></pre>
      </div>
    </section>
