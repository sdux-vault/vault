 ...
 * Symbol: <a href="/docs/references/types/pipeline-upstream-value">PipelineUpstreamValue</a>
 */

import { Component, ViewEncapsulation } from '@angular/core';

@Component({
  selector: 'sdux-pipeline-upstream-value',
  standalone: true,
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Union of all valid upstream values that a pipeline stage may produce.<br/><br/></div>
...
type PipelineUpstreamValue = T | undefined | unknown | unknown | unknown;
          </code></pre>
        </div>
      </section>
      <section class="section">
...
export class PipelineUpstreamValueComponent {}
