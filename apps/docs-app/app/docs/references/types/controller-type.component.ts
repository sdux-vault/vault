 ...
 * Symbol: <a href="/docs/references/types/controller-type">ControllerType</a>
 */

import { Component, ViewEncapsulation } from '@angular/core';

@Component({
  selector: 'sdux-controller-type',
  standalone: true,
  template: `<div class="docs-container">
      <div class="header">
        <h3>ControllerType</h3>
      </div>
      <header class="docs-header">
        <div class="lead">Union type derived from <a href="/docs/references/const/controller-types">ControllerTypes</a> values.<br/><br/></div>
...
<section class="section">
      ...
      <div class="section-body">
        <p>
          <strong><a href="/docs/references/types/controller-type">ControllerType</a></strong> is a derived type alias.
        </p>
        <p>
