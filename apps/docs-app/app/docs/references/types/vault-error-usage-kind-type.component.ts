 ...
 * Symbol: <a href="/docs/references/types/vault-error-usage-kind-type">VaultErrorUsageKindType</a>
 */

import { Component, ViewEncapsulation } from '@angular/core';

@Component({
  selector: 'sdux-vault-error-usage-kind-type',
  standalone: true,
  template: `<div class="docs-container">
      <div class="header">
        <h3>VaultErrorUsageKindType</h3>
      </div>
      <header class="docs-header">
        <div class="lead">Union type derived from <a href="/docs/references/const/vault-error-usage-kind-types">VaultErrorUsageKindTypes</a> values.<br/><br/></div>
...
<section class="section">
      ...
      <div class="section-body">
        <p>
          <strong><a href="/docs/references/types/vault-error-usage-kind-type">VaultErrorUsageKindType</a></strong> is a derived type alias.
        </p>
        <p>
...
export class VaultErrorUsageKindTypeComponent {}
