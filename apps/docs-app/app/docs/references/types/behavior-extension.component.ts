...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">A map of extension function names to their implementation functions.
Behaviors may return these objects to expose additional APIs on the
<a href="/docs/references/functions/feature-cell">FeatureCell</a> instance. Keys correspond to method names added to the
cell’s public API surface.<br/><br/></div>
