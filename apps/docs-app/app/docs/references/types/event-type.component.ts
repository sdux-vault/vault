 ...
 * Symbol: <a href="/docs/references/types/event-type">EventType</a>
 */

import { Component, ViewEncapsulation } from '@angular/core';

@Component({
  selector: 'sdux-event-type',
  standalone: true,
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Union type derived from <a href="/docs/references/const/event-types">EventTypes</a> values.<br/><br/></div>
...
<section class="section">
      ...
      <div class="section-body">
        <p>
          <strong><a href="/docs/references/types/event-type">EventType</a></strong> is a derived type alias.
        </p>
        <p>
