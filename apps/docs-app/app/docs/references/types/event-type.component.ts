...
@Component({
  ...
  template: `<div class="docs-container">
    <div class="header">
      <h2><a href="/docs/references/types/event-type">EventType</a></h2>
    </div>
    <header class="docs-header">
      <div class="lead">
        Union type derived from
        <a href="/docs/references/const/event-types">EventTypes</a>
        values.<br /><br />
      </div>
    </header>
    ...
    <section class="section">
      ...
      <div class="section-body">
        <p>
          <strong
            ><a href="/docs/references/types/event-type">EventType</a></strong
          >
