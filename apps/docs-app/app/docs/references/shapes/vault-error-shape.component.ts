...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Canonical error representation emitted by the Vault pipeline.<br/><br/>
<a href="/docs/references/classes/vault-error">VaultError</a> normalizes thrown values from any pipeline stage into a
consistent shape that addon error behaviors can transform and that
consumers can observe from the global VaultErrorPublicService signal.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            Optional <a href="/docs/references/functions/feature-cell">FeatureCell</a> key.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
...
Useful for debugging, logging, and devtools visualization.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
...
Enables reactive timelines and differentiating repeated errors.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
