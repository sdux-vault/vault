...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Shape representing optional arguments attached to a Chrome trace event.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            <a href="/docs/references/functions/feature-cell">FeatureCell</a> key associated with the event.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
