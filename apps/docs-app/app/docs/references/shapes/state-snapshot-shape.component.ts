...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Defines the immutable snapshot shape representing <a href="/docs/references/functions/feature-cell">FeatureCell</a> state at a specific moment.
This interface exposes loading, value, and error indicators used by consumers to reason about current state.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            Error associated with the state at this moment, or null if no error is present.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
          ...
          <td class="column-auto">
            The resolved value for this snapshot, or undefined when no value exists.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
