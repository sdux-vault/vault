...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Describes the shape of a pipeline event emitted during <a href="/docs/references/functions/feature-cell">FeatureCell</a> execution.
This interface defines the core event contract used for diagnostics, Devtools inspection, and lifecycle tracking.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-300">
            ...
            <p class="type">type: <a href="/docs/references/types/event-boundary-type">EventBoundaryType</a></p>
            
          </td>
          <td class="column-auto">
            The event boundary type.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>cell</strong>
          ...
          <td class="column-auto">
            Identifier of the <a href="/docs/references/functions/feature-cell">FeatureCell</a> associated with the event.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>error?</strong>
          ...
          <td class="column-auto">
            Optional partial snapshot of <a href="/docs/references/functions/feature-cell">FeatureCell</a> state at the time of emission.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
          ...
          <td class="column-300">
            ...
            <p class="type">type: <a href="/docs/references/types/event-type">EventType</a></p>
