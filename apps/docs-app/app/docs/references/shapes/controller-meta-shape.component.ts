 ...
 * Symbol: <a href="/docs/references/shapes/controller-meta-shape">ControllerMetaShape</a>
 */

import { Component, ViewEncapsulation } from '@angular/core';

@Component({
  selector: 'sdux-controller-meta-shape',
  standalone: true,
  template: `<div class="docs-container">
      <div class="header">
        <h3>ControllerMetaShape</h3>
      </div>
      <header class="docs-header">
        <div class="lead">Metadata shape describing a registered controller&#39;s static configuration.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            Configuration key used to locate controller options in the config registry.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
          ...
          <td class="column-auto">
            Unique identifier for this controller.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
          ...
          <td class="column-auto">
            Whether this controller requires a valid license to operate.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>type</strong>
...
export class ControllerMetaShapeComponent {}
