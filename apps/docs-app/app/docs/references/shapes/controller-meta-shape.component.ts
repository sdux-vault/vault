...
@Component({
  ...
  template: `<div class="docs-container">
    <div class="header">
      <h2>
        <a href="/docs/references/shapes/controller-meta-shape"
          >ControllerMetaShape</a
        >
      </h2>
    </div>
    <header class="docs-header">
      <div class="lead">
        Metadata shape describing a registered controller&#39;s static
        configuration.<br /><br />
      </div>
    </header>
          ...
          <tbody>
            <tr>
              ...
              <td class="column-auto">
                Configuration key used to locate controller options in the
