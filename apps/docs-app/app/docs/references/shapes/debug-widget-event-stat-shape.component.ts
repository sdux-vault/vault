...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Shape representing aggregate statistics computed from debug widget events.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            Long task count and maximum duration from performance entries.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
