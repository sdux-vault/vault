...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Structured shape used to represent a state update packet flowing into the
...
upstream behaviors including resolve, merge, filters, and reducers.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-300">
            ...
            <p class="type">type: T | undefined | null | <a href="/docs/references/types/deferred-type">DeferredType</a></p>
            
          </td>
          <td class="column-auto">
            The state value to apply. This may be the raw state value or the resolved
upstream value type as defined by the pipeline.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
