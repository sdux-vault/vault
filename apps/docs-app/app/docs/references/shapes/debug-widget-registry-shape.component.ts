...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Shape representing the serialized <a href="/docs/references/functions/feature-cell">FeatureCell</a> registry in a debug dump.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-300">
            ...
            <p class="type">type: <a href="/docs/references/shapes/serialized-feature-cell-shape">SerializedFeatureCellShape</a>[]</p>
            
          </td>
          <td class="column-auto">
            Array of serialized <a href="/docs/references/functions/feature-cell">FeatureCell</a> entries.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>licenseSummary?</strong>
            
            <p class="type">type: <a href="/docs/references/shapes/debug-widget-license-summary-shape">DebugWidgetLicenseSummaryShape</a></p>
