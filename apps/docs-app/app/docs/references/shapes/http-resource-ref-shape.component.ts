...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Structural interface representing a reactive, asynchronously resolved resource.<br/><br/>
...
to interact with resource-backed values in a fully framework-agnostic way.<br/><br/>
Implementations may be backed by:
- Angular HttpResourceRef
- Signals
- Observables
- Promises
- Custom adapters or test doubles<br/><br/>
Consumers should treat all methods as side-effect free accessors.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            Returns the most recent error produced by the resource, if any.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Indicates whether the resource currently holds a resolved value.<br/><br/>
...
track resolution state independently.<br/><br/>
          </td>
        </tr><tr>
          <td>
