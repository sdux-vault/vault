...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Shape representing an enriched pipeline event captured by the debug widget.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-300">
            ...
            <p class="type">type: <a href="/docs/references/types/debug-widget-latency-category-type">DebugWidgetLatencyCategoryType</a></p>
          ...
          <td class="column-300">
            ...
            <p class="type">type: <a href="/docs/references/types/debug-widget-event-source-type">DebugWidgetEventSourceType</a> | string</p>
