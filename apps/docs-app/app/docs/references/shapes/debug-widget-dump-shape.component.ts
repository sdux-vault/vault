...
@Component({
  ...
  template: `<div class="docs-container">
    ...
    <header class="docs-header">
      <div class="lead">
        Shape representing a complete debug dump exported from the debug
        widget.<br /><br />
      </div>
    </header>
          ...
          <tbody>
            ...
            <tr>
              <td class="column-300">
                ...
                <p class="type">
                  type:
                  <a
                    href="/docs/references/shapes/debug-widget-long-tasks-shape"
                    >DebugWidgetLongTasksShape</a
                  >[]
                </p>
              </td>
              <td class="column-auto">
            ...
            <tr>
              <td class="column-300">
                ...
                <p class="type">
                  type:
                  <a href="/docs/references/shapes/debug-widget-registry-shape"
                    >DebugWidgetRegistryShape</a
                  >
                </p>
              </td>
              <td class="column-auto">
