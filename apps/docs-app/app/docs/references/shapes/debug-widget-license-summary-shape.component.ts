...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Shape summarizing license validation states across registered FeatureCells.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            Number of FeatureCells that timed out during license verification.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>valid</strong>
