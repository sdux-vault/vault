...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Shape representing a single Chrome trace format event for timeline export.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-300">
            ...
            <p class="type">type: <a href="/docs/references/shapes/debug-widget-trace-event-args-shape">DebugWidgetTraceEventArgsShape</a></p>
          ...
          <td class="column-300">
            ...
            <p class="type">type: <a href="/docs/references/types/debug-widget-event-trace-phase-type">DebugWidgetEventTracePhaseType</a></p>
          ...
          <td class="column-300">
            ...
            <p class="type">type: <a href="/docs/references/types/debug-widget-event-instant-scope-type">DebugWidgetEventInstantScopeType</a></p>
            
          </td>
          <td class="column-auto">
            Scope for instant events.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>tid?</strong>
