...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Message shape dispatched to controllers when a pipeline operation fails.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-300">
            ...
            <p class="type">type: <a href="/docs/references/shapes/vault-error-shape">VaultErrorShape</a> | unknown</p>
