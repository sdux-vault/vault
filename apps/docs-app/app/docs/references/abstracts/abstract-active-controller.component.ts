...
@Component({
  ...
  template: `<div class="docs-container">
    <div class="header">
      <h2>
        <a href="/docs/references/abstracts/abstract-active-controller"
          >AbstractActiveController</a
        >
      </h2>
    </div>
    <header class="docs-header">
      <div class="lead">
        ...
        state changes and participate in pipeline admission voting.<br /><br />
      </div>
    </header>
        ...
        <table aria-label="Constructor">
          ...
          <tbody>
            <tr>
              ...
              <td>
                Creates an active controller and subscribes to the global error
                stream.<br /><br />
              </td>
            </tr>
          </tbody>
        ...
        <table aria-label="Methods">
          ...
          <tbody>
            <tr>
              ...
              <td>
                Tears down the controller and unsubscribes from the error
                stream.<br /><br />
              </td>
            </tr>
            <tr>
        ...
        <table aria-label="Properties">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="column-auto">
                Tracks whether the global error service currently holds an
                error.<br /><br />
              </td>
            </tr>
            <tr>
