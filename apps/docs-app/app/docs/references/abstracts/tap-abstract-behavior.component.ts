...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Abstract base class for tap behaviors in the Vault pipeline.<br/><br/>
...
pre- and post-reducer tap behaviors.<br/><br/></div>
...
<section class="section">
        ...
        <ul>
          <li><a href="/docs/references/contracts/behavior-contract">BehaviorContract</a></li>
                ...
                <td>
                  Creates a new tap behavior instance.<br/><br/>
                </td>
              </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            Resets the tap behavior to its initial state.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            Indicates that tap behaviors participate critically in the pipeline.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>critical</strong>
