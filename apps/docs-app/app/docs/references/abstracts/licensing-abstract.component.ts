...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Stub abstract class that simulates the licensing lifecycle for tests.<br/><br/></div>
            ...
            <tbody>
              <tr>
                <td>
                  ...
                  <p>inputs:</p>
        <ul>
        <li>_ctx: <a href="/docs/references/contexts/licensable-class-context">LicensableClassContext</a></li>
        </ul>
                  
                  
                </td>
                <td>
                  Creates a stub licensing instance.<br/><br/>
                </td>
              </tr>
            </tbody>
          </table>
