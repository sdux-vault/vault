...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Abstract base class for error callback behaviors that execute consumer-supplied
error handlers during the error stage of the Vault pipeline.<br/><br/></div>
...
<section class="section">
        ...
        <li>key: string</li><li>behaviorCtx: <a href="/docs/references/contexts/behavior-class-context">BehaviorClassContext</a></li>
                  ...
                  <p>implements:</p>
        <ul>
          <li><a href="/docs/references/contracts/error-callback-behavior-contract">ErrorCallbackBehaviorContract</a></li>
        </ul>
                </td>
                <td>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            Executes the consumer-supplied error callback against the current error and state.<br/><br/>
          </td>
        </tr><tr>
          <td>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-300">
            ...
            <p class="default">default: <a href="/docs/references/const/behavior-types">BehaviorTypes</a>.CoreErrorCallback</p>
          </td>
          <td class="column-auto">
