...
@Component({
  ...
  template: `<div class="docs-container">
    <div class="header">
      <h2>
        <a href="/docs/references/abstracts/abstract-error-transform-behavior"
          >AbstractErrorTransformBehavior</a
        >
      </h2>
    </div>
    <header class="docs-header">
      <div class="lead">
        Abstract base behavior for transforming errors during pipeline
        execution. This class defines the contract and lifecycle hooks required
        for error transformation behaviors.<br /><br />
      </div>
    </header>
            ...
            <tr>
              <td>
                ...
                <ul>
                  <li>
                    <a
                      href="/docs/references/contracts/error-transform-behavior-contract"
          ...
          <tbody>
            <tr>
              ...
              <td class="column-auto">
                Indicates that this error transform behavior is critical and
                always executed.<br /><br />
              </td>
            </tr>
            <tr>
              <td class="column-300">
