 ...
 * Symbol: <a href="/docs/references/functions/vault-log">vaultLog</a>
 */

import { Component, ViewEncapsulation } from '@angular/core';

@Component({
  selector: 'sdux-vault-log',
  standalone: true,
...
<section class="section">
      ...
      <div class="section-body">
        <table aria-label="API">
          ...
          <tbody>
            <tr>
      <td>
        <p><strong><a href="/docs/references/functions/vault-log">vaultLog</a>()</strong></p>
      ...
      <td>
        Emits a log-level Vault log message.<br/><br/>
      </td>
    </tr>
          </tbody>
        </table>
...
export class vaultLogComponent {}
