 ...
 * Symbol: <a href="/docs/references/functions/is-promise">isPromise</a>
 */
...
@Component({
  ...
  template: `<div class="docs-container">
    <div class="header">
      <h2><a href="/docs/references/functions/is-promise">isPromise</a></h2>
    </div>
...
export class isPromiseComponent {}
