...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Angular-facing service that exposes the current global Vault error as a signal.<br/><br/>
...
and clear it when appropriate.<br/><br/></div>
        <div class="class-meta">
      <span class="meta-badge meta-injectable">
          Injectable
        </span>
    </div>
      </header>
          ...
          <table aria-label="Constructor">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  Creates a new <a href="/docs/references/functions/vault-error-service">VaultErrorService</a> instance and subscribes to global error updates.<br/><br/>
                </td>
              </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            Clears the currently stored global error.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Cleans up internal subscriptions when the service is destroyed.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-300">
            ...
            <p class="modifiers">readonly</p>
            <p class="type">type: <a href="/docs/references/contracts/vault-private-error-service-contract">VaultPrivateErrorServiceContract</a></p>
            
          </td>
          <td class="column-auto">
            Internal Vault error service used as the authoritative error source.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>error</strong>
...
<section class="section">
      ...
      <div class="section-body">
        <table aria-label="API">
          ...
          <tbody>
            <tr>
      <td>
        <p><strong><a href="/docs/references/functions/vault-error-service">VaultErrorService</a>()</strong></p>
      ...
      <td>
        Angular-facing service that exposes the current global Vault error as a signal.<br/><br/>
This service bridges the internal VaultPrivateErrorService into Angular’s
signal system, allowing UI layers to observe global error state reactively
and clear it when appropriate.<br/><br/>
      </td>
    </tr>
          </tbody>
        </table>
