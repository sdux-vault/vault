...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Safely converts an arbitrary value into a JSON string representation.
This function wraps JSON.stringify with enhanced handling for non-serializable
values, including:<br/><br/>
functions
Error objects
Map and Set instances
circular references<br/><br/>
...
use in logging and debugging utilities.<br/><br/></div>
      ...
      <div class="section-body">
        <table aria-label="API">
          ...
          <tbody>
            <tr>
      <td>
        <p><strong><a href="/docs/references/functions/safe-stringify">safeStringify</a>(value)</strong></p>
        <p>inputs:</p>
      <ul>
        <li>value: unknown</li>
      </ul>
...
If serialization fails for any reason, a fallback string &amp;quot;[unserializable]&amp;quot;
is returned. The replacer ensures stable and predictable stringification for
use in logging and debugging utilities.<br/><br/>
      </td>
    </tr>
          </tbody>
        </table>
