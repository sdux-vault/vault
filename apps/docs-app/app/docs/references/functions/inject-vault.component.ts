 ...
 * Symbol: <a href="/docs/references/functions/inject-vault">injectVault</a>
 */
                ...
                <p>
                  <strong
                    ><a href="/docs/references/functions/inject-vault"
                      >injectVault</a
                    >(featureCellClass)</strong
                  >
                </p>
                <p>inputs:</p>
                <ul>
                  <li>featureCellClass: unknown</li>
                </ul>
                <p>returns:</p>
                <ul>
                  <li>
...
export class injectVaultComponent {}
