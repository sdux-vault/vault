 ...
 * Symbol: <a href="/docs/references/functions/is-object">isObject</a>
 */

import { Component, ViewEncapsulation } from '@angular/core';

@Component({
  selector: 'sdux-is-object',
  standalone: true,
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Determines whether a value is a non-null object.<br/><br/></div>
...
<section class="section">
      ...
      <div class="section-body">
        <table aria-label="API">
          ...
          <tbody>
            <tr>
      <td>
        <p><strong><a href="/docs/references/functions/is-object">isObject</a>()</strong></p>
      ...
      <td>
        Determines whether a value is a non-null object.<br/><br/>
      </td>
    </tr>
          </tbody>
        </table>
...
export class isObjectComponent {}
