...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Validates whether a string conforms to the Vault behavior key format.
A valid behavior key must follow the structure:
SDUX::&amp;lt;Domain&amp;gt;::&amp;lt;Name&amp;gt;
Where &amp;lt;Domain&amp;gt; and &amp;lt;Name&amp;gt; begin with an uppercase character and contain
only alphanumeric characters.<br/><br/></div>
      ...
      <div class="section-body">
        <table aria-label="API">
          ...
          <tbody>
            <tr>
      <td>
        <p><strong><a href="/docs/references/functions/validate-behavior-key">validateBehaviorKey</a>(key)</strong></p>
        <p>inputs:</p>
      <ul>
        <li>key: string</li>
      </ul>
