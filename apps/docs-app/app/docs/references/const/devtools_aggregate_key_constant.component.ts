 ...
 * Symbol: <a href="/docs/references/const/devtools_aggregate_key_constant">DEVTOOLS_AGGREGATE_KEY_CONSTANT</a>
 */

import { Component, ViewEncapsulation } from '@angular/core';

@Component({
  selector: 'sdux-devtools_aggregate_key_constant',
  standalone: true,
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">String token used to uniquely identify the DevTools Aggregate <a href="/docs/references/functions/feature-cell">FeatureCell</a>.<br/><br/>
...
export class DEVTOOLS_AGGREGATE_KEY_CONSTANTComponent {}
