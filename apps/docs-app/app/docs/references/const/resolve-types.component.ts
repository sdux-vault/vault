...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Enumerates the available resolve strategy identifiers used by resolve
behaviors. These identifiers indicate how a <a href="/docs/references/functions/feature-cell">FeatureCell</a> obtains its initial
and subsequent state values during the resolve stage of the pipeline.<br/><br/>
...
- Promise — Resolve from a promise source.<br/><br/></div>
