 ...
 * Symbol: <a href="/docs/references/const/vault_continue">VAULT_CONTINUE</a>
 */

import { Component, ViewEncapsulation } from '@angular/core';

@Component({
  selector: 'sdux-vault_continue',
  standalone: true,
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Sentinel symbol that signals the pipeline to continue processing.<br/><br/></div>
...
export class VAULT_CONTINUEComponent {}
