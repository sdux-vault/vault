 ...
 * Symbol: <a href="/docs/references/const/vault_noop">VAULT_NOOP</a>
 */

import { Component, ViewEncapsulation } from '@angular/core';

@Component({
  selector: 'sdux-vault_noop',
  standalone: true,
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Sentinel symbol that signals the pipeline to skip the current operation.<br/><br/></div>
...
export class VAULT_NOOPComponent {}
