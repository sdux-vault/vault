 ...
 * Symbol: <a href="/docs/references/const/controller-types">ControllerTypes</a>
 */

import { Component, ViewEncapsulation } from '@angular/core';

@Component({
  selector: 'sdux-controller-types',
  standalone: true,
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Enumeration of controller category classifications.<br/><br/></div>
        ...
        <div class="section-body">
          <table aria-label="Properties">
            ...
            <tbody>
              <tr>
          <td class="column-300">
            <strong>CoreAbstain</strong>
          </td>
          <td class="column-auto">
            <code>coreAbstain</code>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>Error</strong>
