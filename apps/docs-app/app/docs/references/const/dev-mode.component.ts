 ...
 * Symbol: <a href="/docs/references/const/dev-mode">DevMode</a>
 */
...
@Component({
  selector: 'sdux-dev-mode',
  standalone: true,
  imports: [BrandNameComponent, PackageNameComponent],
  template: `<div class="docs-container">
    <div class="header">
      <h2><a href="/docs/references/const/dev-mode">DevMode</a></h2>
    </div>
    <header class="docs-header">
      <div class="lead">
        Singleton accessor for Vault development mode state.<br /><br />
      </div>
    </header>
      ...
      <div class="section-body">
        <table aria-label="API">
          ...
          <tbody>
            ...
            <tr>
              <td>
                <p><strong>setDevMode(isDevMode)</strong></p>
                <p>inputs:</p>
                <ul>
                  <li>isDevMode: boolean</li>
                </ul>
                <p>returns:</p>
                <ul>
                  <li>void</li>
