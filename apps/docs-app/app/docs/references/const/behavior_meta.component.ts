 ...
 * Symbol: <a href="/docs/references/const/behavior_meta">BEHAVIOR_META</a>
 */

import { Component, ViewEncapsulation } from '@angular/core';

@Component({
  selector: 'sdux-behavior_meta',
  standalone: true,
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Symbol key used to attach behavior metadata to a behavior class.<br/><br/></div>
...
export class BEHAVIOR_METAComponent {}
