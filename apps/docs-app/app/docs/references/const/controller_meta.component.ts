 ...
 * Symbol: <a href="/docs/references/const/controller_meta">CONTROLLER_META</a>
 */
...
@Component({
  ...
  template: `<div class="docs-container">
    <div class="header">
      <h2>
        <a href="/docs/references/const/controller_meta">CONTROLLER_META</a>
      </h2>
    </div>
...
export class CONTROLLER_METAComponent {}
