...
@Component({
  ...
  template: `<div class="docs-container">
    ...
    <header class="docs-header">
      <div class="lead">
        Stub class that simulates
        <a href="/docs/references/functions/feature-cell">FeatureCell</a>
        construction and builder output for tests.<br /><br />
      </div>
    </header>
            ...
            <tr>
              ...
              <td>
                ...
                <a href="/docs/references/functions/feature-cell"
                  >FeatureCell</a
                >
                instance, ignoring all arguments.<br /><br />
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table aria-label="Methods">
          ...
          <tbody>
            <tr>
              ...
              <td>
                Returns a stub builder object with no-op pipeline methods.<br /><br />
              </td>
            </tr>
          </tbody>
        </table>
