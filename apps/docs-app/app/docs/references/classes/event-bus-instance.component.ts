...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Implements the EventBusInterface by managing pipeline and queue event streams.
This class provides gated event emission based on development mode and exposes observable streams for subscribers.
It is instantiated once and registered globally to support DevTools integration.<br/><br/></div>
...
<section class="section">
        ...
        <ul>
          <li><a href="/docs/references/contracts/event-bus-contract">EventBusContract</a></li>
                ...
                <td>
                  Creates a new <a href="/docs/references/functions/event-bus">EventBus</a> instance and exposes it on the global object for DevTools access.<br/><br/>
                </td>
              </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>event: <a href="/docs/references/shapes/event-shape">EventShape</a></li>
          </ul>
            <p>returns: void</p>
          </td>
          <td>
            Emits a pipeline event to subscribed observers when development mode is active.<br/><br/>
          </td>
        </tr><tr>
          <td>
