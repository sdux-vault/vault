 ...
 * Symbol: <a href="/docs/references/classes/vault-usage-promise-factory-required-error">VaultUsagePromiseFactoryRequiredError</a>
 */

import { Component, ViewEncapsulation } from '@angular/core';

@Component({
  selector: 'sdux-vault-usage-promise-factory-required-error',
  standalone: true,
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Thrown when a Promise-based state method receives a raw value instead
of a factory function that returns a Promise.<br/><br/></div>
            ...
            <tbody>
              <tr>
                <td>
                  ...
                  <p>extends:</p>
        <ul>
          <li><a href="/docs/references/classes/vault-usage-error">VaultUsageError</a></li>
        </ul>
