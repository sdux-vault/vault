        ...
        <table aria-label="Properties">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="column-auto">
                When enabled, properties whose incoming value is null are
                removed from the merged output. When disabled, incoming null
                values are preserved during the merge operation.<br /><br />
              </td>
            </tr>
          </tbody>
        </table>
