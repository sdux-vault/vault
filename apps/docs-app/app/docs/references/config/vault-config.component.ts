...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Configuration options supplied to Vault at initialization.<br/><br/></div>
...
is always enforced with the production key regardless of this flag.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
...
When true, Vault emits more verbose warnings and validation errors.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>licenses?</strong>
            
            <p class="type">type: <a href="/docs/references/shapes/vault-licensing-shape">VaultLicensingShape</a>[]</p>
...
If validation does not occur within this window, the <a href="/docs/references/functions/feature-cell">FeatureCell</a>
is denied. Defaults to 15,000 ms. Set to 0 to disable timeout.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>logLevel?</strong>
            
            <p class="type">type: <a href="/docs/references/types/log-level-type">LogLevelType</a></p>
            
          </td>
          <td class="column-auto">
            Controls the verbosity of internal logging.
Common levels: &#39;debug&#39; | &#39;info&#39; | &#39;warn&#39; | &#39;error&#39; | &#39;off&#39;.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
