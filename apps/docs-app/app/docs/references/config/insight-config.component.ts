...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Defines configuration options that control which data is included in emitted insight events.
This interface allows consumers to specify the level of state, payload, error, and queue detail captured during monitoring.<br/><br/></div>
...
Commonly used to distinguish different monitoring consumers.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
          ...
          <td class="column-auto">
            Whether error information should be included in emitted insight events.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
...
reducer results, merge patches, or replacement values.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
...
<a href="/docs/references/functions/feature-cell">FeatureCell</a>’s current state value.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
