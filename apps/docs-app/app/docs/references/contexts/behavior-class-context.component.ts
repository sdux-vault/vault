...
@Component({
  ...
  template: `<div class="docs-container">
      <div class="header">
        <h3>BehaviorClassContext</h3>
      </div>
      <header class="docs-header">
        <div class="lead">Context provided to behavior class constructors during instantiation.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            Key of the <a href="/docs/references/functions/feature-cell">FeatureCell</a> this behavior instance operates within.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
          ...
          <td class="column-auto">
            Optional license payload for behaviors requiring license validation.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
