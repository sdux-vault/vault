...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Extended behavior class context providing direct state access for tab-sync behaviors.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            Live reference to the <a href="/docs/references/functions/feature-cell">FeatureCell</a>&#39;s mutable state snapshot.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>state$</strong>
          ...
          <td class="column-auto">
            Subject used to emit state snapshots to the <a href="/docs/references/functions/feature-cell">FeatureCell</a>.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
