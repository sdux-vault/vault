...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Runtime context supplied to controller class instances during pipeline execution.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            Unique key of the <a href="/docs/references/functions/feature-cell">FeatureCell</a> this controller is attached to.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
          ...
          <td class="column-auto">
            Requests an abort for the pipeline identified by the trace ID.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
          ...
          <td class="column-auto">
            Requests a revote for the pipeline identified by the trace ID.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
