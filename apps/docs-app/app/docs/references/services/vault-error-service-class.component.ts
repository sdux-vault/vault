...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Singleton service that aggregates and exposes the current Vault error state.
Subscribes to the private error service and mirrors updates through a public
observable stream for consumer consumption.<br/><br/></div>
            ...
            <tbody>
              <tr>
                <td>
                  ...
                  <p>implements:</p>
        <ul>
          <li><a href="/docs/references/contracts/vault-error-service-contract">VaultErrorServiceContract</a></li>
        </ul>
                </td>
                <td>
                  Initializes the service and subscribes to the private error stream.<br/><br/>
                </td>
              </tr>
            </tbody>
          </table>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            Internal delegate responsible for low-level error state management.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
