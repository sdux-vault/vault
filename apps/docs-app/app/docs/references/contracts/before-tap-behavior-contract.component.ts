...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Contract for before-tap behaviors that observe state before pipeline resolution.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            Invokes the tap callback with the current pipeline value before resolution.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
