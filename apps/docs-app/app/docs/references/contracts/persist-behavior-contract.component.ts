...
@Component({
  ...
  template: `<div class="docs-container">
      <div class="header">
        <h3>PersistBehaviorContract</h3>
      </div>
      <header class="docs-header">
        <div class="lead">Contract for persistence behaviors that save and restore <a href="/docs/references/functions/feature-cell">FeatureCell</a> state.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            Clears the persisted state from storage.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Persists the current state snapshot to the configured storage.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
