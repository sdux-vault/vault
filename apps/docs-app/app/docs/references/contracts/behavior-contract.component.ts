...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Base interface implemented by all behavior types in the Vault pipeline.<br/><br/>
Behaviors participate in specific pipeline stages based on their declared
<a href="/docs/references/types/behavior-type">BehaviorType</a>, and may optionally expose additional <a href="/docs/references/functions/feature-cell">FeatureCell</a> APIs through
the extendCellAPI hook.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            Extends the <a href="/docs/references/functions/feature-cell">FeatureCell</a> with additional APIs backed by this behavior.<br/><br/>
          </td>
        </tr><tr>
          <td>
            <strong>reset</strong>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            Extension function names this behavior is permitted to override.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
          ...
          <td class="column-auto">
            Whether this behavior is critical for pipeline error handling.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
          ...
          <td class="column-auto">
            Installs fluent configuration APIs onto a <a href="/docs/references/functions/feature-cell">FeatureCell</a> instance.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>key</strong>
          ...
          <td class="column-auto">
            Pipeline classification for this behavior used to determine execution order.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
