...
@Component({
  ...
  template: `<div class="docs-container">
      <div class="header">
        <h3>CoreStateBehaviorContract</h3>
      </div>
      <header class="docs-header">
        <div class="lead">Contract for the core behavior responsible for committing pipeline state.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            Finalizes a controller abort condition without applying state.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>error: <a href="/docs/references/shapes/vault-error-shape">VaultErrorShape</a> | null</li><li>ctx: <a href="/docs/references/contexts/behavior-context">BehaviorContext</a></li>
          </ul>
            <p>returns: void</p>
          </td>
          <td>
          ...
          <td>
            Finalizes a resolved pipeline value.<br/><br/>
          </td>
        </tr><tr>
          <td>
