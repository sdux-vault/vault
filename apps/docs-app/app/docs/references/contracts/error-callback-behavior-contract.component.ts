...
@Component({
  ...
  template: `<div class="docs-container">
      <div class="header">
        <h3>ErrorCallbackBehaviorContract</h3>
      </div>
      <header class="docs-header">
        <div class="lead">Contract for behaviors that invoke consumer error callbacks on pipeline errors.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            Invokes the consumer error callback with the current error and state.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
