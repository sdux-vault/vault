...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Contract for after-tap behaviors that observe state after pipeline resolution.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            Invokes the tap callback with the current pipeline value after resolution.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
