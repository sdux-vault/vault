...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Defines the contract for an event bus responsible for emitting and observing pipeline and queue events.
This interface provides methods for publishing events and subscribing to their corresponding event streams.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            ...
            <p>returns: Observable&lt;<a href="/docs/references/shapes/event-shape">EventShape</a>&gt;</p>
          </td>
          <td>
