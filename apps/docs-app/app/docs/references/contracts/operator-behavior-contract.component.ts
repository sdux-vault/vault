...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Contract for operator behaviors that transform pipeline values.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>value: <a href="/docs/references/types/pipeline-upstream-value">PipelineUpstreamValue</a></li>
          </ul>
            <p>returns: Promise&lt;<a href="/docs/references/types/pipeline-upstream-value">PipelineUpstreamValue</a>&lt;T&gt;&gt;</p>
          </td>
          <td>
            Applies the operator transformation to the current pipeline value.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
