...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Behavior contract for observing pipeline execution events in development mode.<br/><br/>
...
propagate success or error signals associated with a <a href="/docs/references/functions/feature-cell">FeatureCell</a> run.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>cellKey: string</li><li>error: <a href="/docs/references/shapes/vault-error-shape">VaultErrorShape</a></li>
          </ul>
            <p>returns: void</p>
          </td>
          <td>
            Emits a pipeline error event for a <a href="/docs/references/functions/feature-cell">FeatureCell</a>.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Emits a successful pipeline completion event for a <a href="/docs/references/functions/feature-cell">FeatureCell</a>.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
