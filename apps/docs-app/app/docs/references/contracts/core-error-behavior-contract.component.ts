...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Contract for behaviors that normalize raw errors into structured vault errors.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            Converts an unknown error value into a normalized vault error shape.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
