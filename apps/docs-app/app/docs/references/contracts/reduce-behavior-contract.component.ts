...
@Component({
  ...
  template: `<div class="docs-container">
      <div class="header">
        <h3>ReduceBehaviorContract</h3>
      </div>
      <header class="docs-header">
        <div class="lead">Contract for reducer-stage behaviors that transform pipeline state.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            Pipeline behavior type identifier for reducer-stage execution.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
