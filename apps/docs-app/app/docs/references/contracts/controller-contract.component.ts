...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Instance-side contract that all controllers must implement.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            Optional hook that installs a fluent API onto the <a href="/docs/references/functions/feature-cell">FeatureCell</a>.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
            <strong>key</strong>
