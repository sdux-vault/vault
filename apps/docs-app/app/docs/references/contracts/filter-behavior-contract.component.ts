...
@Component({
  ...
  template: `<div class="docs-container">
      <div class="header">
        <h3>FilterBehaviorContract</h3>
      </div>
      <header class="docs-header">
        <div class="lead">Contract for filter behaviors that selectively pass or reject state updates.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>current: <a href="/docs/references/types/pipeline-upstream-value">PipelineUpstreamValue</a></li><li>filter: <a href="/docs/references/types/filter-function">FilterFunction</a></li>
          </ul>
            <p>returns: <a href="/docs/references/types/pipeline-upstream-value">PipelineUpstreamValue</a>&lt;T&gt;</p>
          </td>
          <td>
            Applies the filter function against the current pipeline value.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
