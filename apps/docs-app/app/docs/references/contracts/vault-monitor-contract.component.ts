...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>definition: <a href="/docs/references/config/insight-config">InsightConfig</a></li>
          </ul>
            <p>returns: void</p>
          </td>
          <td>
            Activates global insight tracking with the supplied configuration.<br/><br/>
          </td>
        </tr><tr>
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>cell: string</li><li>behaviorKey: string</li><li>ctx: Readonly&gt;</li>
          </ul>
            <p>returns: void</p>
          </td>
          <td>
          ...
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>cell: string</li><li>behaviorKey: string</li><li>ctx: Readonly&gt;</li><li>error: unknown</li>
          </ul>
            <p>returns: void</p>
          </td>
          <td>
          ...
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>cell: string</li><li>featureCellKey: string</li>
          </ul>
            <p>returns: void</p>
          </td>
          <td>
          ...
          <td>
            Records a license validation attempt for a <a href="/docs/references/functions/feature-cell">FeatureCell</a>.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Records that a license validation was denied.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>behaviorKey: string</li><li>ctx: Readonly&gt;</li><li>error: unknown</li>
          </ul>
            <p>returns: void</p>
          </td>
          <td>
            Records a controller failure event.<br/><br/>
          </td>
        </tr><tr>
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>behaviorKey: string</li><li>ctx: Readonly&gt;</li>
          </ul>
            <p>returns: void</p>
          </td>
          <td>
            Records a controller finalize event.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Records a controller success event.<br/><br/>
          </td>
        </tr><tr>
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>cell: string</li><li>behaviorKey: string</li><li>ctx: Readonly&gt;</li><li>payload?: unknown</li>
          </ul>
            <p>returns: void</p>
          </td>
          <td>
          ...
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>cell: string</li><li>behaviorKey: string</li><li>ctx: Readonly&gt;</li><li>payload: <a href="/docs/references/shapes/controller-decision-shape">ControllerDecisionShape</a></li>
          </ul>
            <p>returns: void</p>
          </td>
          <td>
          ...
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>cell: string</li><li>controllerKey: string</li><li>traceId: string</li><li>vote: ControllerVote</li>
          </ul>
            <p>returns: void</p>
          </td>
          <td>
            Signals the end of an individual controller vote during attempt evaluation.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Signals the end of a decrypt lifecycle event.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Signals the end of a destroy lifecycle event.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>cell: string</li><li>behaviorKey: string</li><li>ctx: Readonly&gt;</li><li>payload: <a href="/docs/references/shapes/vault-error-shape">VaultErrorShape</a></li>
          </ul>
            <p>returns: void</p>
          </td>
          <td>
          ...
          <td>
            Signals the end of a filter lifecycle event.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Signals the end of a merge lifecycle event.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Signals the end of a persist lifecycle event.<br/><br/>
          </td>
        </tr><tr>
          <td>
            <strong>endPersist</strong>
          ...
          <td>
            Signals the end of a reducer lifecycle event.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Signals the end of a replace lifecycle event.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Signals the end of a reset lifecycle event.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Signals the end of a resolve lifecycle event.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>cell: string</li><li>behaviorKey: string</li><li>ctx: Readonly&gt;</li><li>source: string</li>
          </ul>
            <p>returns: void</p>
          </td>
          <td>
            Records that an ingress source has completed.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>cellKey: string</li><li>insight?: <a href="/docs/references/config/insight-config">InsightConfig</a></li>
          </ul>
            <p>returns: void</p>
          </td>
          <td>
            Registers a <a href="/docs/references/functions/feature-cell">FeatureCell</a> for monitoring.<br/><br/>
          </td>
        </tr><tr>
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>cell: string</li><li>behaviorKey: string</li><li>ctx: Readonly&gt;</li><li>payload: string</li>
          </ul>
            <p>returns: void</p>
          </td>
          <td>
          ...
          <td>
            Records a runtime error encountered during pipeline execution.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>cell: string</li><li>controllerKey: string</li><li>traceId: string</li>
          </ul>
            <p>returns: void</p>
          </td>
          <td>
            Signals the start of an individual controller vote during attempt evaluation.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Signals the start of a merge lifecycle event.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            Signals the start of a reset lifecycle event.<br/><br/>
          </td>
        </tr><tr>
          <td>
          ...
          <td>
            ...
            <p>inputs:</p>
          <ul>
           <li>cell: string</li><li>behaviorKey: string</li><li>ctx: Readonly&gt;</li><li>message: string</li>
          </ul>
            <p>returns: void</p>
          </td>
          <td>
