...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Runtime extension contract for behaviors that expose a fromStream API.<br/><br/>
...
execution through a <a href="/docs/references/functions/feature-cell">FeatureCell</a> instance.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            Function used to bridge an observable stream into the <a href="/docs/references/functions/feature-cell">FeatureCell</a> pipeline.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
