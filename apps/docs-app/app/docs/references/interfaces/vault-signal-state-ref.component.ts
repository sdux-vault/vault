...
@Component({
  ...
  template: `<div class="docs-container">
    ...
    <header class="docs-header">
      <div class="lead">
        Reactive signal-based view of a
          ...
          <tbody>
            <tr>
              ...
              <td class="column-auto">
                Holds the most recent error emitted by the pipeline or null when
                no error exists.<br /><br />
              </td>
            </tr>
            <tr>
              <td class="column-300">
              ...
              <td class="column-auto">
                ...
                <a href="/docs/references/functions/feature-cell"
                  >FeatureCell</a
                >
                currently holds a non-null resolved value.<br /><br />
              </td>
            </tr>
            <tr>
              <td class="column-300">
              ...
              <td class="column-auto">
                ...
                <a href="/docs/references/functions/feature-cell"
                  >FeatureCell</a
                >
                is currently processing a pipeline operation.<br /><br />
              </td>
            </tr>
            <tr>
              <td class="column-300">
              ...
              <td class="column-auto">
                Holds the resolved pipeline value or undefined when no value is
                present.<br /><br />
              </td>
            </tr>
          </tbody>
