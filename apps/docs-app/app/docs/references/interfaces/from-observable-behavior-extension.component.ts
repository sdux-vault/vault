...
@Component({
  ...
  template: `<div class="docs-container">
    ...
    <header class="docs-header">
      <div class="lead">
        Extension contract for observable-based
        <a href="/docs/references/functions/feature-cell">FeatureCell</a>
        integration.<br /><br />
        This interface defines the shape of the dynamically injected
        fromObservable API that allows a
        <a href="/docs/references/functions/feature-cell">FeatureCell</a> to
        accept observable sources and expose them as normalized vault state
        references.<br /><br />
      </div>
    </header>
          ...
          <tbody>
            <tr>
              ...
              <td class="column-auto">
                Behavior extension function that installs the fromObservable
                API.<br /><br />
              </td>
            </tr>
          </tbody>
