...
@Component({
  ...
  template: `<div class="docs-container">
      ...
      <header class="docs-header">
        <div class="lead">Runtime extension contract for promise-based state resolution APIs.<br/><br/>
...
methods added to a <a href="/docs/references/functions/feature-cell">FeatureCell</a> to support deferred and promise-based
resolution through the pipeline.<br/><br/></div>
...
<section class="section">
        ...
        <div class="section-body">
          ...
          <td class="column-auto">
            Resolves state from a deferred factory using deferred semantics.<br/><br/>
          </td>
        </tr><tr>
          <td class="column-300">
          ...
          <td class="column-auto">
            Resolves state from a deferred factory using promise semantics.<br/><br/>
          </td>
        </tr>
            </tbody>
          </table>
