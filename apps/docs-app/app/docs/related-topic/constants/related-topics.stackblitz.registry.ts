...
export const RELATED_TOPICS_STACKBLITZ_REGISTRY: RelatedTopicCategoryShape = {
  ...
  items: [
    ...
    {
      link: '/docs/stackblitz#replace-state',
    ...
    {
      link: '/docs/stackblitz#observable',
      display: 'Observable',
    ...
    {
      link: '/docs/stackblitz#http-resource',
    ...
    {
      link: '/docs/stackblitz#basic-filter-reducer',
    ...
    {
      link: '/docs/stackblitz#interceptor-delay',
