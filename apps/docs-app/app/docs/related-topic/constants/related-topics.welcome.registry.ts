...
export const RELATED_TOPICS_WELCOME_REGISTRY: RelatedTopicCategoryShape = {
  baseRoute: '/welcome/getting-started',
  ...
  cross: ['license', 'trademark-usage', 'testing', 'press'],
  ...
  items: [
    ...
    {
      link: '/welcome/supported-languages',
    ...
    {
      link: '/welcome/sdux-redux-similarities',
