...
describe('ExampleComponent', () => {
  ...
  describe('initialization and teaching outputs', () => {
    ...
    it('should report when a pending stepwise prompt should open', async () => {
      ...
      expect(
        component['shouldPromptForPendingStepwise'](true, true)
      ).toBeFalse();
      expect(
        component['shouldPromptForPendingStepwise'](true, false)
      ).toBeTrue();
    });
...
`)
  ...
  describe('editor and collection workflows', () => {
  ...
  describe('async controllers and auxiliary actions', () => {
