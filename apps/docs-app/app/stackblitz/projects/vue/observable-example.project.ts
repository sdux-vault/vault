...
function loadSample(): void {
  ...
  activeStateHint.value = 'State updated via Observable.';
...
<template>
  <div class="example-container">
    <div class="header">
      <div class="title">Vue - SDuX Vault Observable Example</div>
      <div class="subtitle">
