...
function loadSample(): void {
  ...
  activeStateHint.value = 'State updated via deferred promise.';
...
<template>
  <div class="example-container">
    <div class="header">
      <div class="title">Vue - SDuX Vault Promise Example</div>
      <div class="subtitle">
