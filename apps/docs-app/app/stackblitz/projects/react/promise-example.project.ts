...
export function ExampleView() {
  ...
  function loadSample() {
    ...
    setActiveStateHint('State updated via deferred promise.');
  ...
  return (
    <div className="example-container">
      <div className="header">
        <div className="title">React - SDuX Vault Promise Example</div>
        <div className="subtitle">
          This example demonstrates replaceState with a deferred promise
          factory. The value is wrapped in a factory function so that promise
          execution is deferred until the Resolve stage invokes it inside the
          pipeline.
        </div>
      </div>
