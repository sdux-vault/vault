...
`,
    'src/app/app.config.ts': `// app.config.ts
import {
  ApplicationConfig,
...
`,
    'src/app/example.component.scss': `// Local design tokens keep this tutorial example self-contained for copy/paste use.
...
`,
    'src/app/example.component.spec.ts': `import { provideZonelessChangeDetection } from '@angular/core';
...
`,
    'src/app/example.component.ts': `import {
...
`,
    'src/app/example.service.spec.ts': `import { provideHttpClient } from '@angular/common/http';
...
`,
    'src/app/example.service.ts': `// example.service.ts
...
`,
    'src/app/star-wars-character.shape.ts': `// star-wars-character.shape.ts
