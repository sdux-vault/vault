...
export const observableExampleProject: Project = {
  title: 'angular-observable-example',
  template: 'node',
  files: {
    'angular.json': `{
...
`,
    'package.json': `{
  "name": "angular-observable-example",
  "version": "1.0.3",
  "private": true,
  "scripts": {
...
`,
  ...
  <div class="header">
    <div class="title">Angular - SDuX Vault Observable Example</div>
    <div class="subtitle">
...
export class ExampleService {
   ...
   */
  /**
   * Replaces the entire state using an Observable.
   *
  ...
  replace(input: Example[]): void {
    this.#vault.replaceState(of(input));
  }
