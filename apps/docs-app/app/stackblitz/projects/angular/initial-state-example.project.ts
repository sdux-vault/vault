...
export const initialStateExampleProject: Project = {
  title: 'angular-initial-state-example',
  template: 'node',
  files: {
    'angular.json': `{
...
`,
    'package.json': `{
  "name": "angular-initial-state-example",
  "version": "1.0.3",
  "private": true,
  "scripts": {
 ...
 * \`replaceState()\` invocation. The \`initialState\` is the lowest-precedence
 * initialization source — explicit \`replaceState()\` calls always override it.
 */
