...
`,
  ...
  /** Loads sample data into the FeatureCell via a deferred promise factory. */
  function loadSample(): void {
    displayActiveStateHint = false;
    activeStateHint = 'State updated via deferred promise.';
...
<div class="example-container">
  <div class="header">
    <div class="title">Svelte - SDuX Vault Promise Example</div>
    <div class="subtitle">
      This example demonstrates replaceState with a deferred promise factory.
      The value is wrapped in a factory function so that promise execution is
      deferred until the Resolve stage invokes it inside the pipeline.
    </div>
  </div>
  ...
  <div class="section learn-more">
    ...
    <div class="learn-more-links">
      ...
      <a
        href="https://www.sdux-vault.com/docs/pipeline/addons/resolve/with-core-promise-behavior"
        target="_blank"
        rel="noopener noreferrer">Promise Resolve</a>
      <span class="separator">·</span>
      <a
