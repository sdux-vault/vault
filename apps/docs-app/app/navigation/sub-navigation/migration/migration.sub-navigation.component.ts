...
/**
 * Sub-navigation panel for the "Migration" documentation section.
 *
 * This component provides the expandable navigation menu used inside the
 * documentation sidenav for all migration-related pages. It inherits all
 ...
 */
@Component({
  selector: 'sdux-migration-subnavigation',
  standalone: true,
  imports: [
    MatExpansionModule,
    RouterLink,
...
export class MigrationSubNavigationComponent extends NavigationDirective {}
