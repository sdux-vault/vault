...
import { withTabSyncStateBehavior } from '@sdux-vault/core';
...
import { p436Snapshot } from './snap-shots/p436-tab-sync.controller-not-registered.snapshot';

describe('p436: Tab Sync - Controller not registered', () => {
  ...
  it('should have the correct insight events', async () => {
    await vaultSettled(key);
    expectMonitorSnapshot(emitted, p436Snapshot);
  });
});
