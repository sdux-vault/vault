...
import { p281Snapshot } from './snap-shots/p281-error-serivce.replace-with-callbacks.error.snapshot';

describe('p281: Error Service Replace with Callbacks Test', () => {
  ...
  describe('value resolve', () => {
    ...
    it('should have the correct insight events', async () => {
      await vaultSettled(key);
      expectMonitorSnapshot(emitted, p281Snapshot);
    });
  });
});
