...
import { p411Snapshot } from './snap-shots/p411-query.value-append-merge.snapshot';
...
describe('p411: Promise - Query Append Merge Test', () => {
    ...
    await TestBed.configureTestingModule({
      providers: [
        ...
        provideFeatureCell(
          ...
          [withQueryBehavior, withArrayAppendMergeBehavior]
        )
      ]
    });
  ...
  it('should handle query calls from a Promise', async () => {
    ...
    employee = testService.vault.query!('be-001');
    ...
    testService.vault.mergeState({ value: null });
    await flushVaultPipeline();
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, p411Snapshot);
  });
});
