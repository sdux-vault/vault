...
import { p231Snapshot } from './snap-shots/p231-persist.with-session-storage.load.snapshot';

describe('p231: Persist - Session Storage - load', () => {
  ...
  beforeEach(async () => {
    ...
    setSessionStorage(storageKey, getBankEmployeeData());
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, p231Snapshot);
  });
});
