...
import { p233Snapshot } from './snap-shots/p233-persist.with-session-storage.destroy.snapshot';

describe('p233: Persist - Session Storage - destroy', () => {
  let testService: PartialWithSessionStorageService;
  let stopListening: () => void;

  const emitted: any[] = [];
  const storageKey =
    'vault::sessionstorage::partial-persist.with-session-storage::SDUX::Behavior::Persist::SessionStorage';
    ...
    await TestBed.configureTestingModule({
      providers: [
        ...
        provideFeatureCell(
          PartialWithSessionStorageService,
          {
            key: 'partial-persist.with-session-storage',
            initialState: null,
            insights: {} as any
          },
  ...
  it('should not remove the bank employees in session storage', async () => {
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, p233Snapshot);
  });
});
