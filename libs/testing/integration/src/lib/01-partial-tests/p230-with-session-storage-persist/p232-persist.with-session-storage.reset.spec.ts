...
import { p232Snapshot } from './snap-shots/p232-persist.with-session-storage.reset.snapshot';

describe('p232: Persist - Session Storage - reset', () => {
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, p232Snapshot);
  });
});
