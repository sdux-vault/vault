...
import { p052Snapshot } from './snap-shots/p052-from-stream.non-init.push-merge.snapshot';
...
describe('p052: From Stream - Non-Init Merge', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      providers: [
        ...
        provideFeatureCell(
          partialFromStreamService,
          { key: 'partial-from-stream', insights: {} as any } as any,
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, p052Snapshot);
  });
});
