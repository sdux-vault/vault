...
import { p050Snapshot } from './snap-shots/p050-from-stream.push-merge.snapshot';
...
describe('p050: From Stream - Push Merge', () => {
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, p050Snapshot);
  });
});
