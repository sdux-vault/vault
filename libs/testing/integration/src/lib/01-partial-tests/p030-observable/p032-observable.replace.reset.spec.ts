...
import { p032Snapshot } from './snap-shots/p032-observable.replace.reset.snapshot';
...
describe('p032: From Observable - Replace Reset Test', () => {
  ...
  it('should replace after receiving a fromObservable', async () => {
    ...
    testService.vault.replaceState(
      testService.getSource(undefined as any) as any
    );
    await flushVaultPipeline();
    ...
    testService.vault.replaceState(testService.getSource(null as any) as any);
    await flushVaultPipeline();
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, p032Snapshot);
  });
});
