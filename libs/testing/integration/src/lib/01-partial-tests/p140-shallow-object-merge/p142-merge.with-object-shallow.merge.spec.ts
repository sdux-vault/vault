...
import { p142Snapshot } from './snap-shots/p142-merge.with-object-shallow.merge.snapshot';

describe('p142: Merge - WithObjectShallow - With Initial Values Merge Test', () => {
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, p142Snapshot);
  });
});
