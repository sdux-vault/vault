...
import { p311Snapshot } from './snap-shots/p311-state.merge-with-callbacks.snapshot';

describe('p311: State Service Merge with Emit State Callbacks Test', () => {
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, p311Snapshot);
  });
});
