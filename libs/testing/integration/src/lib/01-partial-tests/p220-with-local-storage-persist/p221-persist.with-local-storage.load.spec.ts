...
import { p221Snapshot } from './snap-shots/p221-persist.with-local-storage.load.snapshot';

describe('p221: Persist - Local Storage - load', () => {
  ...
  it('should replace the bank employees with in local storage', async () => {
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, p221Snapshot);
  });
});
