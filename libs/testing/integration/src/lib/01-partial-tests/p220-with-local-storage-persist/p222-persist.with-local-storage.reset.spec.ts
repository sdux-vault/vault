...
import { p222Snapshot } from './snap-shots/p222-persist.with-local-storage.reset.snapshot';

describe('p222: Persist - Local Storage - reset', () => {
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, p222Snapshot);
  });
});
