...
import { p220Snapshot } from './snap-shots/p220-persist.with-local-storage.snapshot';

describe('p220: Persist - Local Storage ', () => {
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, p220Snapshot);
  });
});
