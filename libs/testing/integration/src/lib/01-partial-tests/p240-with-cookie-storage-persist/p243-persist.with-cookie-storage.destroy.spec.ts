...
import { p243Snapshot } from './snap-shots/p243-persist.with-cookie-storage.destroy.snapshot';

describe('p243: Persist - Cookie Storage - destroy', () => {
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, p243Snapshot);
  });
});
