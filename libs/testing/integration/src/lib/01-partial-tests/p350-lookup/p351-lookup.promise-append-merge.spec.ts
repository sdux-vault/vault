...
import { p351Snapshot } from './snap-shots/p351-lookup.promise-append-merge.snapshot';
...
describe('p351: Promise - Lookup Append Merge Test', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      providers: [
        ...
        provideFeatureCell(
          PartialLookupService,
          { key: 'partial-lookup', initialState: [], insights: {} as any },
          [withLookupBehavior, withArrayAppendMergeBehavior]
        )
      ]
    });
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, p351Snapshot);
  });
});
