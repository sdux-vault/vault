...
import { p354Snapshot } from './snap-shots/p354-lookup.promise-merge.error.snapshot';
...
describe('p354: Promise - Merge Error Test', () => {
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, p354Snapshot);
  });
});
