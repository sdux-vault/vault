...
import { p381Snapshot } from './snap-shots/p381-stepwise-filter.bound.merge.snapshot';

describe('p381: Stepwise Filter - Merge - Bound Method Test', () => {
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, p381Snapshot);
  });
});
