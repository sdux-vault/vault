...
import { p392Snapshot } from './snap-shots/p392-stepwise-reducer.inline.replace.snapshot';

describe('p392: Stepwise Reducer - Replace - Inline Method Test', () => {
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, p392Snapshot);
  });
});
