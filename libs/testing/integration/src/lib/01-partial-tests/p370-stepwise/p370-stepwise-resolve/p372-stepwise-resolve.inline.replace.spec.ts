...
import { p372Snapshot } from './snap-shots/p372-stepwise-resolve.inline.replace.snapshot';

describe('p372: Stepwise Resolve - Replace - Inline Method Test', () => {
  ...
  beforeEach(async () => {
    ...
    await testService.initializeInlineMethod();
  });
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, p372Snapshot);
  });
});
