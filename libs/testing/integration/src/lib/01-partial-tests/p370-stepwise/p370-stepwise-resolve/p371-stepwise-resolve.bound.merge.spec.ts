...
import { p371Snapshot } from './snap-shots/p371-stepwise-resolve.bound.merge.snapshot';

describe('p371: Stepwise Resolve - Merge - Bound Method Test', () => {
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, p371Snapshot);
  });
});
