...
import { p015Snapshot } from './snap-shots/p015-resolve.value.replace.error.snapshot';

describe('p015: Resolve - Replace - With Initial State Error Test', () => {
  ...
  it('should replace the bank employees with an error and isLoading', async () => {
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, p015Snapshot);
  });
});
