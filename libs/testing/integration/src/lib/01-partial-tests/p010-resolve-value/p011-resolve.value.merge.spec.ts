...
import { p011Snapshot } from './snap-shots/p011-resolve.value.merge.snapshot';

describe('p011: Resolve - Value - No Initial Values Merge', () => {
  ...
  it('should have the correct insight events', async () => {
    await vaultSettled(key);
    expectMonitorSnapshot(emitted, p011Snapshot);
  });
});
