...
import { p041Snapshot } from './snap-shots/p041-from-observable.merge.snapshot';
...
describe('p041: From Observable - Merge', () => {
  ...
  it('should merge after receiving a fromObservable', async () => {
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, p041Snapshot);
  });
});
