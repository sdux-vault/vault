...
import { p342Snapshot } from './snap-shots/p342-from-promise.replace.snapshot';
...
describe('f342: From Promise - Replace Reset', () => {
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, p342Snapshot);
  });
});
