...
import { p332Snapshot } from './snap-shots/p332-promise.replace.reset.snapshot';
...
describe('f332: From Promise - Replace Reset Test', () => {
  ...
  it('should replace after receiving a fromPromise', async () => {
    ...
    testService.vault.replaceState(testService.formatPromiseInputAsValue(null));
    await flushVaultPipeline();
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, p332Snapshot);
  });
});
