...
import { p323Snapshot } from './snap-shots/p323-merge.with-array-push.merge.snapshot';

describe('p323: WithArrayPush - Initial and Mixed Values Merge Test', () => {
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, p323Snapshot);
  });
});
