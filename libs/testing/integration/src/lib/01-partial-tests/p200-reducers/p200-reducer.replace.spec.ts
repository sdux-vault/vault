...
import { p200Snapshot } from './snap-shots/p200-reducer.replace.snapshot';

describe('p200: Reducer - Replace Test', () => {
  ...
  it('should replace the bank employees with reducers', async () => {
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, p200Snapshot);
  });
});
