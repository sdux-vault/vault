...
import { p170Snapshot } from './snap-shots/p170-controller.with-delay.replace.snapshot';

describe('p170: Controller - Delay Test - Replace', () => {
  ...
  it('should replace the bank employees with withDelay', async () => {
  ...
  it('should have the correct insight events', async () => {
    jasmine.clock().tick(1_000);
    await vaultSettled(key);
    expectMonitorSnapshot(emitted, p170Snapshot);
  });
});
