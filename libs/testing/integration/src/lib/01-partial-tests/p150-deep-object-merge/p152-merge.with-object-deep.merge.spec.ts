...
import { p152Snapshot } from './snap-shots/p152-merge.with-object-deep.merge.snapshot';

describe('p152: Merge - WithObjectDeep - With Initial Values Merge Test', () => {
    ...
    await TestBed.configureTestingModule({
      providers: [
        ...
        provideFeatureCell(
          PartialMergeWithObjectDeepService,
          {
            key: 'partial-merge.with-object-deep',
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, p152Snapshot);
  });
});
