...
import { p183Snapshot } from './snap-shots/p183-operator.with-distinct-until-change.replace.error.snapshot';

describe('p183: Operator - Distinct Until Change - Error Tests', () => {
  ...
  it('should have the correct insight events', async () => {
    ...
    expectMonitorSnapshot(emitted, p183Snapshot);
  });
});
