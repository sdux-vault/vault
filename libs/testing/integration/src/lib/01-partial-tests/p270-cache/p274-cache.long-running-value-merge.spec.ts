...
import { p274Snapshot } from './snap-shots/p274-cache.long-running-value-merge.snapshot';
...
describe('p274: Value - Long-Running Cache Test', () => {
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, p274Snapshot);
  });
});
