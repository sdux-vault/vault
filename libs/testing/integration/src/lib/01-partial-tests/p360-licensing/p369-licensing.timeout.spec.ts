...
import { p369Snapshot } from './snap-shots/p369-licensing.timeout.snapshot';
...
describe('p369: Licensing - Timeout Test', () => {
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, p369Snapshot);
  });
});
