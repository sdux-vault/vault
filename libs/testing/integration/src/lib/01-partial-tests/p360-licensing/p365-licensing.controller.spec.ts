...
import { p365Snapshot } from './snap-shots/p365-licensing.controller.snapshot';
...
describe('p365: Licensing - Controller Test', () => {
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, p365Snapshot);
  });
});
