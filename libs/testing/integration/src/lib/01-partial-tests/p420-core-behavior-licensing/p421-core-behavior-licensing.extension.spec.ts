...
import { p421Snapshot } from './snap-shots/p421-core-behavior-licensing.extension.snapshot';
...
describe('p421: Core Behavior License - Success', () => {
  ...
  it('should have the correct insight events', async () => {
    await vaultSettled(key);
    expectMonitorSnapshot(emitted, p421Snapshot);
  });
});
