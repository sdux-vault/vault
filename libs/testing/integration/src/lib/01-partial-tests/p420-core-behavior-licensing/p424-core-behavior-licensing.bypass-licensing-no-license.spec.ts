...
import { p424Snapshot } from './snap-shots/p424-core-behavior-licensing.bypass-licensing-no-license.snapshot';
...
describe('p424: Core Behavior License - Bypass Licensing with no license', () => {
  ...
  it('should have the correct insight events', async () => {
    ...
    expectMonitorSnapshot(emitted, p424Snapshot);
  });
});
