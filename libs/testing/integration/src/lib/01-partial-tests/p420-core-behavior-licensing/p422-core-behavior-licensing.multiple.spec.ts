...
import { p422Snapshot } from './snap-shots/p422-core-behavior-licensing.multiple.snapshot';
...
describe('p422: Core Behavior License - Multiple Success', () => {
  ...
  it('should have the correct insight events', async () => {
    await vaultSettled(key);
    expectMonitorSnapshot(emitted, p422Snapshot);
  });
});
