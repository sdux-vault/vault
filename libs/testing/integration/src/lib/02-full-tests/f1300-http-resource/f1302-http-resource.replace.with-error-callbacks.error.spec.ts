...
import { f1302Snapshot } from './snap-shots/f1302-http-resource.replace.with-error-callbacks.error.snapshot';

describe('f1302: HttpResource - Replace - With ErrorCallbacks and encryption - Error Test', () => {
  ...
  it('should have the correct insight events', async () => {
    ...
    expectMonitorSnapshot(emitted, f1302Snapshot);
  });
});
