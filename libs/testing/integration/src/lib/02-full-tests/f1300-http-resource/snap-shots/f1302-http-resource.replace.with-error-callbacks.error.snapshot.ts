...
export const f1302Snapshot = [
  ...
  },
  {
    id: 'id-removed',
    cell: 'full-test-with-encrypted-error-callback',
    behaviorKey: 'full-test-with-encrypted-error-callback::license',
  ...
  },
  {
    ...
    cell: 'full-test-with-encrypted-error-callback',
    behaviorKey: 'vault-orchestrator',
    name: 'stage:start:core-callback-error',
    timestamp: 'ts-removed',
    monotonicTimestamp: 'mts-removed',
    type: 'stage',
    boundary: 'start',
  ...
  },
  {
    ...
    cell: 'full-test-with-encrypted-error-callback',
    behaviorKey: 'vault-orchestrator',
    name: 'stage:end:core-callback-error',
    timestamp: 'ts-removed',
    monotonicTimestamp: 'mts-removed',
    type: 'stage',
    boundary: 'end',
