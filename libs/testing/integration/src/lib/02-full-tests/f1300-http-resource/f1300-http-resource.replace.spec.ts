...
import { f1300Snapshot } from './snap-shots/f1300-http-resource.replace.snapshot';

/*************************************************
 * Test: f1300 — HttpResource Replace
 *
 *************************************************/

describe('f1300: HttpResource - Replace Test', () => {
  const key = 'full-test';
  ...
  it('should have the correct insight events', async () => {
    ...
    expectMonitorSnapshot(emitted, f1300Snapshot);
  });
});
