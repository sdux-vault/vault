...
import { f304Snapshot } from './snap-shots/f304-from-stream.merge.no-auto-reset.error.snapshot';
 ...
 * Initial value is []
 *
 * no auto reset on error
 *************************************************/

describe('f304: From Stream - No Auto-Reset Errors Merge', () => {
  const key = 'full-test';
  ...
  it('should have the correct insight events', async () => {
    ...
    expectMonitorSnapshot(emitted, f304Snapshot);
  });
});
