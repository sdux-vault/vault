...
import { f1200Snapshot } from './snap-shots/f1200-licensing.snapshot';

describe('f1200: Licensing - Replace Test', () => {
  const key = 'full-test';
  ...
  it('should replace with a valid license', async () => {
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, f1200Snapshot);
  });
});
