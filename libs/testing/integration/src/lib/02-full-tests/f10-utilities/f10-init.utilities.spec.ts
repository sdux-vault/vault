...
import { f10Snapshot } from './snap-shots/f10-init.utilities.snapshot';

describe('f10: Incremental Updates - From an initial statue Replace', () => {
  ...
  it('should have the correct insight events', async () => {
    jasmine.clock().tick(1000);
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, f10Snapshot);
  });
});
