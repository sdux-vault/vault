...
import { f703Snapshot } from './snap-shots/f703-promise.merge.without-error-callbacks.error.snapshot';

describe('f703: Promise - Merge - Without ErrorCallbacks - Error Test', () => {
  const key = 'full-test';
  ...
  it('should have the correct insight events', async () => {
    await flushVaultPipeline();
    expectMonitorSnapshot(emitted, f703Snapshot);
  });
});
