...
import { f106Snapshot } from './snap-shots/f106-hydrate-with-local-storage.snapshot';
...
describe('f106: Hydrate with LocalStorage set Test', () => {
  ...
  it('should have the correct insight events', async () => {
    jasmine.clock().tick(1_000);
    await vaultSettled(testService.vault.key);
    expectMonitorSnapshot(emitted, f106Snapshot);
  });
});
