/**
 * An abstracted method to ensure the pipeline is working
 *
 * This verifies that all the employees are in the state.value()
 *
 * @param employees The employees to verify
 * @returns void
 */
//eslint-disable-next-line
export const verifyAllEmployees = (employees: any): void => {
